...
Publishing with provenance is also how you prove ownership when claiming your app in a Diex marketplace.
...
- [Diex Apps documentation](https://docs.diex.com/developers/extend/apps/getting-started/quick-start)
- [diex-sdk CLI reference](https://www.npmjs.com/package/diex-sdk)
