...
- **A hands-on reference** — this is the app built in the [Document Generator tutorial](https://docs.diex.com/developers/extend/apps/tutorials/document-generator/overview), a tour through most of the Diex SDK.
