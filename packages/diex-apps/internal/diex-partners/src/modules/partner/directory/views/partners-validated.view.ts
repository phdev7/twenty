import { ViewFilterOperand, ViewType, defineView } from 'diex-sdk/define';
...
// object's existing view in place instead of deleting it (Diex blocks deleting an object's only view).
