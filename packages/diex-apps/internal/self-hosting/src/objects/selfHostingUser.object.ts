import { defineObject, FieldType, RelationType, OnDeleteAction, STANDARD_OBJECT_UNIVERSAL_IDENTIFIERS } from 'diex-sdk/define';
...
export default defineObject({
  ...
  fields: [
    ...
    },
    {
      ...
      name: 'isDiex',
      label: 'Is Diex',
      description: 'Whether the user is from Diex',
      defaultValue: false,
      universalIdentifier:
        UNIVERSAL_IDENTIFIERS.objects.selfHostingUser.fields.isDiex
          .universalIdentifier,
    },
    {
      type: FieldType.TEXT,
