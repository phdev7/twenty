...
Connect your Linear account to Diex to create issues and look up teams
...
> notice on the Connections tab, ask your Diex admin to follow the
...
### 2. Wire the credentials into Diex
