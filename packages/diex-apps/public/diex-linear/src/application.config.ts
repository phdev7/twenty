...
export default defineApplication({
  ...
  displayName: 'Linear',
  description:
    'Connect Linear to Diex. Each workspace member connects their own Linear account; logic functions can then create issues and read team data on their behalf.',
  ...
  termsUrl: 'https://github.com/diexhq/diex?tab=License-1-ov-file#readme',
  websiteUrl: 'https://www.diex.com',
  serverVariables: {
    LINEAR_CLIENT_ID: {
      description:
