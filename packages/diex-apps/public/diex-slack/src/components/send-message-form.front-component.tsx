...
import { closeSidePanel, enqueueSnackbar, unmountFrontComponent } from 'diex-sdk/front-component';
...
const callAppRoute = async <TResponse,>(
  ...
  const apiBaseUrl = process.env.DIEX_API_URL;
  const token =
