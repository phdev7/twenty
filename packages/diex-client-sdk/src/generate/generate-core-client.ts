...
import { DEFAULT_API_URL_NAME } from 'diex-shared/application';
...
import diexClientTemplateSource from './diex-client-template.ts?raw';
...
export const generateCoreClientFromSchema = async ({
  ...
  const templateSource =
    clientWrapperTemplateSource ?? diexClientTemplateSource;
...
// an installed diex-client-sdk package (dist/core.mjs and dist/core.cjs).
