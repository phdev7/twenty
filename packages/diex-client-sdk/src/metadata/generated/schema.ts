...
export interface ClientConfig {
    ...
    allowRequestsToDiexIcons: Scalars['Boolean']
...
export interface ClientConfigGenqlSelection{
    ...
    allowRequestsToDiexIcons?: boolean | number
...
export const enumEngineComponentKey = {
   ...
   OPEN_WHATSAPP_CONVERSATION: 'OPEN_WHATSAPP_CONVERSATION' as const,
