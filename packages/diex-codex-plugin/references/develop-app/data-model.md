...
Use this reference for Diex app objects, fields, relations, roles, and permissions.
...
- Prefer generated app entity patterns from `yarn diex dev:add`.
...
- Avoid duplicating data that already exists on core Diex objects.
