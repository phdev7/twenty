...
crossDocContracts.assertDiexMcpFormattingContract(fail);
...
if (failures.length > 0) {
  console.error('Diex Codex plugin validation failed:');
...
console.log('Diex Codex plugin validation passed.');
