...
const PUBLIC_DOCS_MCP_SERVER_NAME = 'diex-docs';
const PUBLIC_DOCS_MCP_URL = 'https://docs.diex.com/mcp';
...
const isAllowedDocumentationHost = (hostname) => {
  ...
  return (
    ...
    host === 'example.diex.com' ||
    host === 'myworkspace.diex.com' ||
    host === 'myworkspace.customdomain.com' ||
    host === 'your-diex-server.com' ||
    host === 'app.diex.com' ||
    host === 'diex.com' ||
    host === 'docs.diex.com' ||
    host === 'www.docker.com' ||
