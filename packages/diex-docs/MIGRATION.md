...
### Documentation Files
- **69 MDX files** copied from diex-website to diex-docs
...
3. Set subdirectory to `packages/diex-docs`
4. Mintlify will auto-deploy and generate search embeddings

## Status

This migration has been completed. The legacy `packages/diex-website` package
has been removed, and documentation now lives in `packages/diex-docs`.
