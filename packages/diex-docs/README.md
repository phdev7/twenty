...
Official documentation for Diex CRM, powered by [Mintlify](https://mintlify.com).

## 🌐 Live Site

Visit the documentation at [docs.diex.com](https://docs.diex.com)

## 📚 Content

This repository contains:
- **User Guide** (46 pages) - Complete guide for Diex users
- **Developers** (24 pages) - Technical documentation for developers
- **Diex UI** (25 pages) - UI component library documentation
...
```bash
# From the diex monorepo root
npx nx run diex-docs:dev
```
...
1. Edit MDX files in the appropriate directory:
   ...
   - `diex-ui/` - Component documentation
...
4. For each translated locale pulled from Crowdin, ensure a `packages/diex-docs/l/<language>/navigation.json` file exists. These files contain **labels only**; page slugs always come from the base structure.
...
npx nx run diex-docs:validate
```

## 🔗 Links

- [Diex Website](https://diex.com)
- [GitHub Repository](https://github.com/diexhq/diex)
...
2. Make your changes in the `packages/diex-docs` directory
3. Test locally with `npx nx run diex-docs:dev`
4. Submit a pull request

## 📄 License

This documentation is part of the Diex project and is licensed under [AGPL-3.0](../../LICENSE).
