...
- `objectUniversalIdentifier` specifies which object this view applies to. It can be a custom object you defined or a standard Diex object.
...
All enums above are exported from `diex-sdk/define`.
