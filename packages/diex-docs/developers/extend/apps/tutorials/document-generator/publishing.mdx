...
export default defineApplication({
  ...
  websiteUrl: 'https://docs.diex.com/developers/extend/apps',
...
Also add the `diex-app` keyword to `package.json` so the app is discoverable:
...
tarball to a Diex server's private registry instead. To surface a published app
