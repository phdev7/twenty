...
You've been choosing between software that's easy to start but impossible to change, and software that's flexible but takes months to set up. Diex is the third option: **a production-ready CRM you can reshape as you go.**


## What makes Diex different

Diex is a platform you can build on, not a product you configure.
...
<CardGroup cols={2}>
  ...
  <Card img="/images/user-guide/halftone/dev-api.png">
    ...
    React, TypeScript. Your team already knows how to extend Diex. No proprietary languages, no gatekeeping.
  </Card>
...
and PostgreSQL. Diex opens the CRM market
...
- **Teams that want a CRM they never have to think
  about.** Diex rewards teams that want to stay close to
...
<Card title="Ready to get started?" icon="rocket" href="/getting-started/quickstart">
  Set up Diex in under 5 minutes — cloud or self-hosted.
</Card>
