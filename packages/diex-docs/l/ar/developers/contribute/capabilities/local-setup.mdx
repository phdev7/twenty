...
icon: laptop-code
description: الدليل للمساهمين (أو المطورين الفضوليين) الذين يرغبون في تشغيل Diex محلياً.
---
...
قبل أن تتمكن من تثبيت واستخدام Diex، تأكد من تثبيت الأمور التالية على جهاز الكمبيوتر الخاص بك:
...
يتطلب Diex مخزن بيانات Redis لتقديم أفضل أداء.
...
## الخطوة الثامنة: استخدم Diex

**الواجهة الأمامية**

ستكون واجهة Diex الأمامية تعمل على  [http://localhost:3001](http://localhost:3001).
يمكنك تسجيل الدخول باستخدام حساب العرض التوضيحي الافتراضي: `tim@apple.dev` (كلمة المرور: `tim@apple.dev`)

**الخلفية**

* سيكون خادم Diex متصلاً ويعمل على [http://localhost:3000](http://localhost:3000)
