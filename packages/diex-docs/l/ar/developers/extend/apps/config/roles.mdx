...
* يمكن للمحددات الإشارة إلى الكائنات والحقول التي يملكها تطبيقك أو إلى كائنات Diex القياسية.
...
* اطّلع على مثال عملي: [`hello-world/src/roles/function-role.ts`](https://github.com/diexhq/diex/blob/main/packages/diex-apps/hello-world/src/roles/function-role.ts).
