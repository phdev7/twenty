...
والمستضافة ذاتيًا، يتم تقديم هذا المسار بواسطة خادم Diex الخاص بك
(مثلًا: `http://localhost:2020/s/documents/generate`). على Diex Cloud، يقوم `RestApiClient`
...
محسوسة) ويسقط في نظيف، صفحة قابلة للطباعة تعرض فقط محتوى القالب- نفس مظهر PDF والمعاينة داخل التطبيق.
  [انظر المساعد](https://github.com/diexhq/diex/blob/main/packages/diex-apps/examples/document-generator/src/utils/render-document.ts).
