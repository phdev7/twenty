...
export default defineApplication({
  ...
  websiteUrl: 'https://docs.diex.com/l/ar/developers/extend/apps',
...
[`packages/XXapps/examples/document-Generator`](https://github.com/diexhq/diex/tree/main/packages/diex-apps/examples/document-generator).
