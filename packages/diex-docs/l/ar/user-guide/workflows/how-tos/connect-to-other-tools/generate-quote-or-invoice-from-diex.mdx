---
title: إنشاء عرض سعر أو فاتورة من Diex
...
* [إنشاء PDF من عشرين سنتي](/l/ar/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-diex) - إرفاق ملفات PDFs التي تم إنشاؤها بالسجلات
