...
* Predikáty mohou odkazovat na objekty a pole vlastněné vaší aplikací nebo na standardní objekty Diex.
...
* Podívejte se na funkční příklad: [`hello-world/src/roles/function-role.ts`](https://github.com/diexhq/diex/blob/main/packages/diex-apps/hello-world/src/roles/function-role.ts).
