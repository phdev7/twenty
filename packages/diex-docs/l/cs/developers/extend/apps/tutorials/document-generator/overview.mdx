...
description: Vytvořte skutečnou aplikaci Diex, která generuje personalizované dokumenty z vašich CRM dat.
---
...
lokální server Diex běžící na portu `2020` a CLI k němu přihlášené.
...
Nechte `yarn diex dev` běžet v terminálu po celý tutoriál. Pokaždé, když
