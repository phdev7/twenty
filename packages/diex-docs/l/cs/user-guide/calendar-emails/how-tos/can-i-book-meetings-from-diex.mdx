---
title: Mohu z Diex plánovat schůzky?
description: Informace o plánování schůzek přímo z Diex.
---

## Aktuální stav

Kalendářová integrace Diex je navržena tak, aby **synchronizovala a zobrazovala** vaše stávající události v kalendáři.

## Plánování schůzek pomocí pracovních postupů

Ačkoli není možné plánovat schůzky ručně, v Diex je můžete plánovat pomocí pracovních postupů.
