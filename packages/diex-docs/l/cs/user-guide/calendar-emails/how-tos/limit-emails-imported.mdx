...
description: Ovládejte, které emaily se importují do Diex.
---

## Přehled

Ve výchozím nastavení Diex synchronizuje všechny externí emaily z vaší připojené poštovní schránky. Můžete omezit, co se importuje, pomocí **výběru složek** a **nastavení viditelnosti**.
...
Zprávy mezi kolegy (stejná doména) je možné synchronizovat v Diex:
