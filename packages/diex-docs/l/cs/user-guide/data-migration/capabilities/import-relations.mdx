...
Diex podporuje import relací mezi objekty během importu CSV. To vám umožní propojit záznamy (např. přiřadit Lidi ke Společnostem) jako součást migrace dat.
...
## Jak relace fungují v Diex

### Jedna ku mnoha / Mnoho ku jedné

Diex podporuje standardní relace, kde se jeden záznam propojuje s mnoha dalšími:
...
Před importem strany „mnoho“ musí záznamy na straně „jedna“ již v Diex existovat.
...
4. Diex automaticky propojí každý záznam s odpovídajícím nadřazeným objektem
...
<Note>**Propojení na členy pracovního prostoru**: Pokud relace směřuje na členy pracovního prostoru (váš tým přihlašující se do Diex), odkazujte je pomocí jejich **e-mailové adresy**, nikoli jména.</Note>
