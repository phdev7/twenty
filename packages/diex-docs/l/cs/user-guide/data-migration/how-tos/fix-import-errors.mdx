...
Po nahrání souboru a namapování sloupců Diex vaše data ověří:

1. **Proběhne validace** — Diex zkontroluje každý řádek na chyby
...
| --------------------------------------------------------------------- | ------------------------------------------------------------------------ |
| Duplicitní hodnoty zvýrazněné žlutě                                   | Hodnota již existuje v Diex nebo se ve vašem souboru vyskytuje dvakrát |
...
**Možnost 3: Nechte Diex aktualizovat existující záznam**
...
3. Diex aktualizuje existující záznam místo vytvoření duplicity
...
Pokud se shoduje alespoň jeden jedinečný identifikátor, Diex záznam aktualizuje.
</Note>
...
3. Zkontrolujte, zda záznamy v Diex již existují
...
To znamená, že v Diex neexistuje společnost s tímto konkrétním identifikátorem.
...
Pokoušíte se propojit se záznamem, který v Diex neexistuje.
...
Sloupec ve vašem souboru nelze namapovat, protože pole v Diex neexistuje.
...
1. **Uživatel nepřijal pozvánku** — uživatel zatím v Diex neexistuje
2. **Používáte uživatelské ID ze starého systému** — Diex nedokáže spárovat ID z jiného systému
3. **Nesprávný formát e-mailu** — e-mail neodpovídá účtu uživatele v Diex

### Jak to opravit

1. Ujistěte se, že všichni uživatelé **přijali svou pozvánku** do vašeho pracovního prostoru Diex
2. Použijte **e-mailovou adresu** uživatele (ne jeho jméno nebo ID ze starého systému)
3. Použijte stejný e-mail, jaký použili k připojení do Diex
...
<Check>Formát domény přesně odpovídá formátu Diex</Check>
...
1. **Stáhněte si ukázkový soubor** — uvidíte přesný formát, který Diex očekává
