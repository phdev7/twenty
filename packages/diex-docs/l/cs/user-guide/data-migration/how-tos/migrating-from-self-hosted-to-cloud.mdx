...
description: Podrobný průvodce krok za krokem pro migraci vaší instance Diex hostované na vlastním serveru do Diex Cloud.
---

## Přehled

Tento průvodce vás provede migrací vašich dat z instance Diex hostované na vlastním serveru do Diex Cloud. Proces zahrnuje zřízení vašeho cloudového pracovního prostoru, export dat a jejich opětovný import.
...
1. Přejděte na [app.diex.com](https://app.diex.com) a vytvořte nový pracovní prostor
...
<Tip>
  Migrujete velký nebo složitý pracovní prostor? [Najměte si certifikovaného partnera Diex](https://diex.com/partners/list?categories=HOSTING\&ref=docs-migrate-cloud), který za vás zajistí kompletní přesun od začátku do konce. *(Nebo do komunikace zapojte náš tým: [contact@diex.com](mailto:contact@diex.com).)*
</Tip>
