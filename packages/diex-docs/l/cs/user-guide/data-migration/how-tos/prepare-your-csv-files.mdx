...
description: Kompletní návod krok za krokem, jak naformátovat data pro import do Diex.
---
...
**Toto je nejdůležitější krok.** Ukázkový soubor ukazuje přesné názvy sloupců a formát, který Diex očekává.
...
Diex vynucuje jedinečnost u některých polí. Duplicity způsobí chyby při importu.
...
3. Zkontrolujte duplicity, které už v Diex existují
...
* Musí být jedinečné (žádné duplicity v souboru ani v Diex)
...
* Musí být jedinečné v rámci vašeho souboru i v Diex
...
* **Odkazy / Štítek odkazu**: `Diex`
* **Odkazy / URL odkazu**: `https://diex.com`
...
* **Volitelné**: Diex automaticky generuje ID, pokud nejsou zadána
...
* Nadřazený záznam musí v Diex již existovat
...
## Krok 6: Ujistěte se, že pole v Diex existují
