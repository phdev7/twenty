---
title: Glosář
description: Seznamte se se základní terminologií používanou v aplikaci Diex.
---

## API

API (rozhraní pro programování aplikací) umožňuje propojení Diex s dalšími softwarovými systémy a vytváření vlastních integrací.
...
Příležitosti v Diex CRM jsou potenciální obchody nebo prodeje s účty či kontakty.
...
Úkoly v Diex CRM jsou přiřazené aktivity týkající se kontaktů, účtů nebo příležitostí.
...
Webhooky jsou automatizované zprávy odesílané z Diex na jiné aplikace při výskytu specifických událostí, což umožňuje synchronizaci dat v reálném čase.
...
"Pracovní prostor" obvykle představuje společnost používající Diex. Obsahuje všechny záznamy a data, která vy a členové vašeho týmu do Diex přidáte.
...
Členové pracovního prostoru jsou uživatelé Diex z vašeho týmu, kteří mají přístup k vašemu pracovnímu prostoru. Mohou být u záznamů přiřazeni jako vlastníci nebo přiřazené osoby.
