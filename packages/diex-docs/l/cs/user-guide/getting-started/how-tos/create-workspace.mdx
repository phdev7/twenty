...
description: Sledujte podrobný návod, jak se zaregistrovat na Diex, vybrat si plán předplatného a nastavit svůj účet.
---
...
1. Přejděte na [Registrace Diex](https://app.diex.com).
...
V případě dotazů nebo potřeby pomoci kontaktujte specializovaný tým podpory na [contact@diex.com](mailto:contact@diex.com) nebo pošlete zprávu na [Discord](https://discord.gg/cx5n4Jzs57).
