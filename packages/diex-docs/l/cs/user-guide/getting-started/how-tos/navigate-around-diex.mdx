---
title: Orientace v prostředí Diex
...
Nabídka příkazů vám v Diex poskytuje **rychlý přístup k akcím**. K němu můžete přistoupit dvěma způsoby:
...
* Přistupujte k smazaným záznamům (Diex podporuje logické i trvalé mazání)
