---
title: Rozvržení
description: Přizpůsobte si, jak v Diex navigujete, procházíte a zobrazujete záznamy.
---

Rozvržení Diex je přizpůsobitelné na třech úrovních: jak v aplikaci navigujete, jak procházíte seznamy záznamů a co vidíte při otevření jednotlivého záznamu.
...
Zobrazení určují, jak se zobrazují seznamy záznamů. Diex podporuje tři typy zobrazení:
