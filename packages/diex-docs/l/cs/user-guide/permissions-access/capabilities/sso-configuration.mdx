...
Jednotné přihlášení (SSO) umožňuje členům vašeho týmu přihlašovat se do Diex pomocí poskytovatele identity vaší organizace. To přináší:
...
* Administrátorský přístup k pracovnímu prostoru Diex

<Note>
**Pro uživatele vlastního hostování, kteří chtějí nastavit SSO**, obraťte se na contact@diex.com
</Note>
...
* Odeberte je z pracovního prostoru Diex
...
* **Mapování skupin**: Namapujte skupiny z IdP na role v Diex (pokud je k dispozici)
* **Proces offboardingu**: Zahrňte Diex do svého pracovního postupu deprovisioningu
...
<Tip>
  Potřebujete pro svou organizaci nastavit SSO? [Najděte certifikovaného partnera Diex](https://diex.com/partners/list?categories=SOLUTIONING\&ref=docs-sso), který se specializuje na SSO a nastavení identity. *(Raději byste do toho přímo zapojili Diex? [contact@diex.com](mailto:contact@diex.com).)*
</Tip>
