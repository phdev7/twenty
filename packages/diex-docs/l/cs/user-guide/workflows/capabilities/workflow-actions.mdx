...
description: Zjistěte, jaké akce jsou k dispozici v pracovních postupech Diex.
---
...
<Note>
E-maily můžete odesílat pouze z poštovních schránek synchronizovaných s vaším vlastním účtem Diex. Odesílání z poštovních schránek ostatních členů týmu (např. e-mail vlastníka účtu) je v plánu.
</Note>
...
Na pozadí je každá akce Code podpořena vlastní **logickou funkcí** — serverovou funkcí v TypeScriptu, která běží na platformě Diex. Když přidáte akci Code, Diex vytvoří pro tento krok vyhrazenou logickou funkci a zobrazí její editor přímo inline, takže kód, který napíšete, zůstává u pracovního postupu.
