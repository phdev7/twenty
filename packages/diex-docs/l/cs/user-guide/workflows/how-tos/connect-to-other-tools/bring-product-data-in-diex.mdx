---
title: Přeneste produktová data do Diex
description: Synchronizujte data produktového katalogu z datového skladu do svého CRM podle plánu.
---

Použijte tento vzor k udržení synchronizace Diex s produktovými daty z vašeho datového skladu (např. Snowflake, BigQuery, PostgreSQL).
...
5. **Upsert Record**: Vytvořte nebo aktualizujte záznam v Diex
