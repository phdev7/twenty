---
title: Vytvořte nabídku nebo fakturu z Diex
...
* [Vygenerovat PDF z Diex](/l/cs/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-diex) — připojte vygenerované soubory PDF k záznamům
