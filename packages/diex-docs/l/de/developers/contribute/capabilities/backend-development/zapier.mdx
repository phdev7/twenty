...
Synchronisieren Sie mühelos Diex mit über 3000 Apps mit [Zapier](https://zapier.com/). Automatisieren Sie Aufgaben, steigern Sie die Produktivität und stärken Sie Ihre Kundenbeziehungen!
...
Führen Sie im Ordner `packages/diex-zapier` aus:
