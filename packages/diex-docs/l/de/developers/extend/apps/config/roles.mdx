...
* Prädikate können auf Objekte und Felder verweisen, die Ihrer App gehören, oder auf Standardobjekte von Diex.
...
* Ein funktionierendes Beispiel finden Sie unter: [`hello-world/src/roles/function-role.ts`](https://github.com/diexhq/diex/blob/main/packages/diex-apps/hello-world/src/roles/function-role.ts).
