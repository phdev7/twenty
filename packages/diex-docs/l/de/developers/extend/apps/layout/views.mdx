...
* `objectUniversalIdentifier` gibt an, auf welches Objekt diese Ansicht angewendet wird. Es kann sich um ein von Ihnen definiertes benutzerdefiniertes Objekt oder ein Standardobjekt von Diex handeln.
...
Alle oben genannten Enums werden aus `diex-sdk/define` exportiert.
