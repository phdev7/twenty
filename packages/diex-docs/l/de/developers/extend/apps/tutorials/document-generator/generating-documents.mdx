...
siehe [`generate-document-input.schema.ts`](https://github.com/diexhq/diex/blob/main/packages/diex-apps/examples/document-generator/src/logic-functions/schemas/generate-document-input.schema.ts).
