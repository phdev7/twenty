...
export default defineApplication({
  ...
  websiteUrl: 'https://docs.diex.com/l/de/developers/extend/apps',
...
Füge auch das Schlüsselwort "diex-app" zu "package.json" hinzu, damit die App entdeckt werden kann:
