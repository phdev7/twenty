---
title: Abrechnung
description: Verstehen Sie die Preisgestaltung von Diex und verwalten Sie Ihr Abonnement.
---

Diex bietet flexible Preispläne, die den Bedürfnissen Ihres Teams entsprechen. Verwalten Sie Ihr Abonnement, verfolgen Sie Workflow-Guthaben und greifen Sie auf Rechnungen zu – alles über **Einstellungen → Abrechnung**.

## Was enthält dieser Abschnitt

<CardGroup cols={2}>
  <Card title="Preispläne" icon="tags" href="/l/de/user-guide/billing/capabilities/pricing-plans">
    Erfahren Sie mehr über die Preispläne von Diex und was enthalten ist.
  </Card>
...
| **Organisation (Selbstgehostet)** | Alles aus Pro + die Premiumfunktionen (SSO, zeilenbasierte Berechtigungen und mehr), Diex-Team-Support, keine Verpflichtung, benutzerdefinierten Code vor der Verteilung als Open Source zu veröffentlichen |
...
**Kann ich Diex kostenlos nutzen?**
Ja! Hosten Sie Diex selbst und erhalten Sie alle Pro-Funktionen kostenlos.
