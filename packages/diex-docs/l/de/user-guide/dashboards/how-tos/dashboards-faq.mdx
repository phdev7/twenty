...
description: Häufig gestellte Fragen zu Dashboards in Diex.
---

<AccordionGroup>
  <Accordion title="Kann ich private Dashboards erstellen?">
    Nein, Dashboards sind derzeit für alle sichtbar, die Zugriff auf deinen Diex-Arbeitsbereich haben. Private Dashboards sind noch nicht verfügbar.
  </Accordion>
  ...
  <Accordion title="Kann ich Dashboards mit externen Benutzerinnen und Benutzern teilen?">
    Nein, das Teilen von Dashboards mit Benutzerinnen und Benutzern außerhalb deines Diex-Arbeitsbereichs (Nicht-Diex-Benutzer) wird derzeit nicht unterstützt.
  </Accordion>
