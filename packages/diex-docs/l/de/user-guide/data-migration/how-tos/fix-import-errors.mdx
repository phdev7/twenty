...
Nachdem Sie Ihre Datei hochgeladen und die Spalten zugeordnet haben, validiert Diex Ihre Daten:

1. **Validierung läuft** — Diex prüft jede Zeile auf Fehler
...
| ------------------------------------------------------------------------------ | ---------------------------------------------------------------------- |
| Doppelte Werte, gelb hervorgehoben                                             | Wert existiert bereits in Diex oder kommt in Ihrer Datei doppelt vor |
...
**Option 3: Diex den vorhandenen Datensatz aktualisieren lassen**
...
3. Diex aktualisiert den vorhandenen Datensatz, statt ein Duplikat zu erstellen
...
Solange ein eindeutiger Bezeichner übereinstimmt, aktualisiert Diex den Datensatz.
</Note>
...
3. Prüfen Sie, ob Datensätze bereits in Diex existieren
...
Das bedeutet, dass es in Diex kein Unternehmen mit diesem spezifischen Bezeichner gibt.
...
Sie versuchen, auf einen Datensatz zu verweisen, der in Diex nicht existiert.
...
Eine Spalte in Ihrer Datei kann nicht zugeordnet werden, weil das Feld in Diex nicht existiert.
...
1. **Benutzer hat seine Einladung nicht angenommen** — der Benutzer existiert noch nicht in Diex
2. **Benutzer-ID aus altem System verwendet** — Diex kann IDs aus einem anderen System nicht zuordnen
3. **Falsches E-Mail-Format** — die E-Mail entspricht nicht dem Diex-Konto des Benutzers

### So beheben Sie den Fehler

1. Stellen Sie sicher, dass alle Benutzer **ihre Einladung** zu Ihrem Diex-Arbeitsbereich **angenommen haben**
2. Verwenden Sie die **E-Mail-Adresse** des Benutzers (nicht seinen Namen oder die alte System-ID)
3. Verwenden Sie dieselbe E-Mail, mit der sie Diex beigetreten sind
...
<Check>Domain-Format entspricht exakt dem Format von Diex</Check>
...
1. **Beispieldatei herunterladen** — sehen Sie das genaue Format, das Diex erwartet
