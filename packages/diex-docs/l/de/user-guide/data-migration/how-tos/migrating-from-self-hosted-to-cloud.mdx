...
description: Schritt-für-Schritt-Anleitung zur Migration Ihrer selbstgehosteten Diex-Instanz zu Diex Cloud.
---

## Übersicht

Diese Anleitung führt Sie durch die Migration Ihrer Daten von einer selbstgehosteten Diex-Instanz zu Diex Cloud. Der Prozess umfasst das Einrichten Ihres Cloud-Arbeitsbereichs, das Exportieren Ihrer Daten und deren erneutes Importieren.
...
1. Gehen Sie zu [app.diex.com](https://app.diex.com) und erstellen Sie einen neuen Arbeitsbereich
...
<Tip>
  Migrieren Sie einen großen oder komplexen Workspace? [Holen Sie sich einen zertifizierten Diex-Partner](https://diex.com/partners/list?categories=HOSTING\&ref=docs-migrate-cloud), der den Umzug Ende-zu-Ende übernimmt. *(Oder binden Sie unser Team ein: [contact@diex.com](mailto:contact@diex.com).)*
</Tip>
