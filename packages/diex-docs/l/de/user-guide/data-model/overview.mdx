...
Jedes Unternehmen arbeitet anders. Die Anpassung Ihres Datenmodells bedeutet, dass Sie Diex um **Ihre** Prozesse herum gestalten können, anstatt Ihre in ein starres System zu zwängen.

Diex bietet volle Flexibilität:
...
Identifizieren Sie die wichtigsten Konzepte, mit denen Sie arbeiten. Diex bietet bereits:
...
<Tip>
  ...
  * **Für Sie erledigt:** [Finden Sie einen zertifizierten Diex-Partner](https://diex.com/partners/list?categories=SOLUTIONING\&ref=docs-data-model), der Ihre Objekte, Felder und Beziehungen entwirft und erstellt.
  * **Onboarding-Paket:** eine 4-stündige, geführte Sitzung zur Gestaltung des Datenmodells mit unserem Team – [contact@diex.com](mailto:contact@diex.com). Siehe [Implementierungsdienstleistungen](/l/de/user-guide/getting-started/capabilities/implementation-services).
</Tip>
