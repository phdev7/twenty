...
description: Folgen Sie einer Schritt-für-Schritt-Anleitung, um sich bei Diex anzumelden, einen Abonnementplan auszuwählen und Ihr Konto einzurichten.
---
...
1. Gehen Sie zu [Diex Sign Up](https://app.diex.com).
...
Bei Fragen oder Hilfe kontaktieren Sie das dedizierte Support-Team unter [contact@diex.com](mailto:contact@diex.com) oder senden Sie eine Nachricht auf [Discord](https://discord.gg/cx5n4Jzs57).
