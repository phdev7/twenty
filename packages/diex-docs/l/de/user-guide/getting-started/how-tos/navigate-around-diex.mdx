...
Das Befehlsmenü gibt Ihnen **schnellen Zugriff auf Aktionen** in Diex. Sie können es auf zwei Weisen aufrufen:
...
* Auf gelöschte Datensätze zugreifen (Diex unterstützt weiches und hartes Löschen)
