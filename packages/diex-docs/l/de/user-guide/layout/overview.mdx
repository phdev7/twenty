---
title: Layout
description: Passen Sie die Navigation, das Durchsuchen und die Anzeige von Datensätzen in Diex an.
---

Das Layout von Diex ist auf drei Ebenen anpassbar: wie Sie in der App navigieren, wie Sie Listen von Datensätzen durchsuchen und was Sie sehen, wenn Sie einen einzelnen Datensatz öffnen.
...
Ansichten steuern, wie Listen von Datensätzen angezeigt werden. Diex unterstützt drei Ansichtstypen:
