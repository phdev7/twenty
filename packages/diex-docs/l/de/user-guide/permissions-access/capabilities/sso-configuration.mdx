...
Single Sign-On (SSO) ermöglicht es Ihren Teammitgliedern, sich mit dem Identitätsanbieter Ihrer Organisation bei Diex anzumelden. Dies bietet:
...
* Administratorzugriff auf den Diex-Arbeitsbereich

<Note>
**Für Self-Hosting-Nutzer, die SSO einrichten möchten**, wenden Sie sich an contact@diex.com
</Note>
...
* Entfernen Sie sie aus dem Diex-Arbeitsbereich
...
* **Gruppenzuordnung**: Ordnen Sie IdP-Gruppen Diex-Rollen zu (falls verfügbar)
* **Offboarding-Prozess**: Beziehen Sie Diex in Ihren Deprovisioning-Workflow ein
...
<Tip>
  Benötigen Sie eine SSO-Konfiguration für Ihre Organisation? [Finden Sie einen zertifizierten Diex-Partner](https://diex.com/partners/list?categories=SOLUTIONING\&ref=docs-sso), der auf SSO und Identitätseinrichtung spezialisiert ist. *(Sie möchten Diex lieber direkt einbeziehen? [contact@diex.com](mailto:contact@diex.com).)*
</Tip>
