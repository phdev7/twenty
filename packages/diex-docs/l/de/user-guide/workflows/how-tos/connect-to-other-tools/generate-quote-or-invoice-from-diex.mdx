---
title: Ein Angebot oder eine Rechnung aus Diex erstellen.
...
* [Ein PDF aus Diex generieren](/l/de/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-diex) — generierte PDFs an Datensätze anhängen
