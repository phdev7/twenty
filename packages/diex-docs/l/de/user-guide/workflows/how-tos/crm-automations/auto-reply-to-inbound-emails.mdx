...
In Diex wird dieser Fingerabdruck als `headerMessageId` am Message-Objekt gespeichert. Ihr Workflow greift ihn auf und übergibt ihn an das Feld In-Reply-To der Aktion Send Email.
...
Jedes Mal, wenn eine E-Mail in Diex eingeht, wird dies ausgelöst.
...
* **Nur an VIPs antworten** — fügen Sie einen Zweig hinzu, der die Domain des Absenders prüft oder ob er in Diex als Kontakt existiert
