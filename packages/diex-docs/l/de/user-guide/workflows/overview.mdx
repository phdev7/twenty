...
2. **Daten in und aus Diex bringen**: Verbinden Sie Diex über API-Aufrufe und Webhooks mit Ihrer Datenbank und anderen Werkzeugen.
...
* **Formular**: Eingaben von Benutzern innerhalb der Diex-Oberfläche zum Zeitpunkt der Ausführung abfragen
...
<Tip>
  ...
  * **Für Sie erledigt:** [Finden Sie einen zertifizierten Diex-Partner](https://diex.com/partners/list?categories=SOLUTIONING\&ref=docs-workflows), der Ihre Automatisierungen von Anfang bis Ende entwirft und erstellt.
  * **Onboarding-Paket:** eine 4-stündige, geführte Sitzung zur Workflow-Erstellung mit unserem Team – [contact@diex.com](mailto:contact@diex.com).
</Tip>
