...
info: Aprende cómo puedes colaborar con Diex en Figma
---
...
1. **Accede al enlace compartido:** Puedes acceder al archivo de Figma del proyecto [aquí](https://www.figma.com/file/xt8O9mFeLl46C5InWwoMrN/Diex).
...
En la barra lateral izquierda, puedes acceder a las diferentes páginas del Figma de Diex. Así es como están organizadas:
