...
y autoalojadas, esa ruta la sirve tu servidor de Diex
(p. ej., `http://localhost:2020/s/documents/generate`). En Diex Cloud, `RestApiClient`
...
[Ver el ayudante](https://github.com/diexhq/diex/blob/main/packages/diex-apps/examples/document-generator/src/utils/render-document.ts).
...
`yarn diex dev:function:logs`, o invocarlo directamente con
