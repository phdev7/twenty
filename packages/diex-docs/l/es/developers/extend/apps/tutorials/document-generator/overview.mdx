...
description: Crea una aplicación real de Diex que genere documentos personalizados a partir de los datos de tu CRM.
---
...
Deja `yarn diex dev` corriendo en un terminal para el tutorial completo. Cada vez que
