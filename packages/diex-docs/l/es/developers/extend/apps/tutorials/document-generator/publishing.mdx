...
export default defineApplication({
  ...
  websiteUrl: 'https://docs.diex.com/l/es/developers/extend/apps',
...
También añade la palabra clave `diex-app` a `package.json` para que la aplicación sea detectable:
