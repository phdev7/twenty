...
description: Guía completa paso a paso para dar formato a tus datos para importarlos en Diex.
---
...
**Este es el paso más importante.** El archivo de ejemplo te muestra los nombres de columna y el formato exactos que Diex espera.
...
Diex exige unicidad en determinados campos. Los duplicados provocarán errores de importación.
...
3. Comprueba si hay duplicados que ya existan en Diex
...
* Debe ser único (sin duplicados en el archivo ni en Diex)
...
* Debe ser único dentro de tu archivo y en Diex
...
* **Enlaces / Etiqueta del enlace**: `Diex`
* **Enlaces / URL del enlace**: `https://diex.com`
...
* **Opcional**: Diex genera IDs automáticamente si no se proporcionan
...
* El registro padre debe existir previamente en Diex
...
## Paso 6: Asegúrate de que los campos existan en Diex
