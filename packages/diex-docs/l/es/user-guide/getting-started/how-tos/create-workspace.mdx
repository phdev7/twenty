...
description: Siga una guía paso a paso sobre cómo registrarse en Diex, elegir un plan de suscripción y configurar su cuenta.
---
...
1. Dirígete a [Diex Sign Up](https://app.diex.com).
...
Para consultas o ayuda, contacta con el equipo de soporte dedicado en [contact@diex.com](mailto:contact@diex.com) o envía un mensaje por [Discord](https://discord.gg/cx5n4Jzs57).
