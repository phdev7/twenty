...
El inicio de sesión único (SSO) permite que los miembros de su equipo inicien sesión en Diex utilizando el proveedor de identidad de su organización. Esto proporciona:
...
* Acceso de administrador al espacio de trabajo de Diex

<Note>
**Para usuarios de autoalojamiento que deseen configurar SSO**, comuníquese con contact@diex.com
</Note>
...
* Elimínelos del espacio de trabajo de Diex
...
* **Asignación de grupos**: Asigne los grupos del IdP a roles de Diex (si está disponible)
* **Proceso de desvinculación**: Incluya Diex en su flujo de trabajo de desaprovisionamiento
...
<Tip>
  ¿Necesitas configurar SSO para tu organización? [Encuentra un partner certificado de Diex](https://diex.com/partners/list?categories=SOLUTIONING\&ref=docs-sso) especializado en la configuración de SSO e identidad. *(¿Prefieres involucrar directamente a Diex? [contact@diex.com](mailto:contact@diex.com).)*
</Tip>
