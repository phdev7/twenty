---
title: Generar una cotización o una factura desde Diex
...
* [Generar un PDF desde Diex](/l/es/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-diex) — adjuntar los PDF generados a los registros
