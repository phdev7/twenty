...
info: Apprenez comment vous pouvez collaborer avec le Figma de Diex
---
...
1. **Accédez au lien partagé :** Vous pouvez accéder au fichier Figma du projet [ici](https://www.figma.com/file/xt8O9mFeLl46C5InWwoMrN/Diex).
...
Sur la barre latérale gauche, vous pouvez accéder aux différentes pages du Figma de Diex. Voici comment elles sont organisées :
