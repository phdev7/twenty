...
bac à sable à l'intérieur de Diex. Notre lecture de l'enregistrement sélectionné, charge les gabarits
...
[composant complet](https://github.com/diexhq/diex/blob/main/packages/diex-apps/examples/document-generator/src/front-components/generate-document-form.front-component.tsx).
</Warning>
...
en ligne via un petit [`Markdown`](https://github.com/diexhq/diex/blob/main/packages/diex-apps/examples/document-generator/src/utils/markdown-to-react.tsx)
.
