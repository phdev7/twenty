...
et auto-hébergées, ce chemin est géré par votre serveur Diex
(par exemple, `http://localhost:2020/s/documents/generate`). Sur Diex Cloud, `RestApiClient`
...
[Voir l'aide](https://github.com/diexhq/diex/blob/main/packages/diex-apps/examples/document-generator/src/utils/render-document.ts).
...
`yarn diex dev:function:logs`, ou l'appeler directement avec
