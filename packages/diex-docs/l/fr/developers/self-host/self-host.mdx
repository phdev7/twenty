...
description: Déployez et gérez Diex sur votre propre infrastructure.
---

<Frame>
  <img src="/images/user-guide/what-is-diex/20.png" alt="IA" />
</Frame>

## Vue d'ensemble

Diex peut être auto-hébergé sur votre propre infrastructure, vous offrant un contrôle total sur vos données et votre déploiement.
