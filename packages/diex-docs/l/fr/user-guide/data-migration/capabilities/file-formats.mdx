...
description: Formats de fichiers pris en charge pour l’importation de données dans Diex.
---

## Formats pris en charge

Diex prend en charge trois formats de fichiers pour l’importation :
