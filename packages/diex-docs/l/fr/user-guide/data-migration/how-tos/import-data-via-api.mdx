...
description: Quand et comment utiliser les API de Diex pour des importations de données à grande échelle.
---

## Vue d'ensemble

Diex propose des **API GraphQL** et **REST** pour l'importation programmatique de données. Utilisez l'API lorsque l'importation CSV n'est pas pratique pour votre volume de données ou lorsque vous avez besoin d'importations automatisées et récurrentes.
...
Diex applique des limites de débit pour garantir la stabilité du système :
...
Diex prend en charge deux types d'API :
...
* Vérifiez que les formats correspondent aux exigences de Diex (voir [Correspondance des champs](/l/fr/user-guide/data-migration/capabilities/field-mapping))
...
* Vérifiez que les données s'affichent correctement dans Diex
...
Contactez-nous à [contact@diex.com](mailto:contact@diex.com) ou découvrez nos [services de mise en œuvre](/l/fr/user-guide/getting-started/capabilities/implementation-services).
