...
description: Guide complet étape par étape pour formater vos données en vue de leur importation dans Diex.
---
...
**C’est l’étape la plus importante.** Le fichier d’exemple vous indique exactement les noms de colonnes et le format attendus par Diex.
...
Diex impose l’unicité sur certains champs. Les doublons provoqueront des erreurs d’import.
...
3. Vérifiez les doublons qui existent déjà dans Diex
...
* Doit être unique (aucun doublon dans le fichier ni dans Diex)
...
* Doit être unique dans votre fichier et dans Diex
...
* **Liens / Libellé du lien**: `Diex`
* **Liens / URL du lien**: `https://diex.com`
...
* **Optionnel**: Diex génère automatiquement des ID s’ils ne sont pas fournis
...
* L’enregistrement parent doit déjà exister dans Diex
...
## Étape 6: Vérifiez que les champs existent dans Diex
