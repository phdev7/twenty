...
description: Suivez un guide étape par étape expliquant comment s'inscrire sur Diex, choisir un plan d'abonnement et configurer votre compte.
---
...
1. Allez sur [Inscription à Diex](https://app.diex.com).
...
Pour toute question ou aide, contactez l'équipe de support dédiée à [contact@diex.com](mailto:contact@diex.com) ou envoyez un message sur [Discord](https://discord.gg/cx5n4Jzs57).
