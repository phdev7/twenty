...
Le menu de commandes vous donne **un accès rapide aux actions** dans Diex. Vous pouvez y accéder de deux manières :
...
* Accéder aux enregistrements supprimés (Diex prend en charge les suppressions logiques et définitives)
