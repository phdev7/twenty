...
L'authentification unique (SSO) permet aux membres de votre équipe de se connecter à Diex en utilisant le fournisseur d'identité de votre organisation. Cela offre :
...
Diex prend en charge le SSO avec :
...
* Accès administrateur à l'espace de travail Diex

<Note>
**Pour les utilisateurs en auto-hébergement souhaitant configurer le SSO**, contactez contact@diex.com
</Note>
...
* Retirez-les de l'espace de travail Diex
...
* **Correspondance de groupes** : Faites correspondre les groupes IdP aux rôles Diex (si disponible)
* **Processus de départ** : Incluez Diex dans votre workflow de déprovisionnement
...
<Tip>
  Vous avez besoin de configurer le SSO pour votre organisation ? [Trouvez un partenaire Diex certifié](https://diex.com/partners/list?categories=SOLUTIONING\&ref=docs-sso) spécialisé en SSO et en gestion des identités. *(Vous préférez impliquer directement Diex ? [contact@diex.com](mailto:contact@diex.com).)*
</Tip>
