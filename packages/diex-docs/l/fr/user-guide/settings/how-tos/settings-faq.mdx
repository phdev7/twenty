...
description: Foire aux questions sur les paramètres de Diex.
---
...
Pour changer votre adresse e-mail, veuillez contacter [contact@diex.com](mailto:contact@diex.com).
</Accordion>
...
* **Sous-domaine** : Utilisez un sous-domaine Diex comme `yourcompany.diex.com`
