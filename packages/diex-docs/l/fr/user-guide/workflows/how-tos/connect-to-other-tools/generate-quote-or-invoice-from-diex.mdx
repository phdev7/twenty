---
title: Générer un devis ou une facture depuis Diex
...
* [Générer un PDF à partir de Diex](/l/fr/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-diex) — joindre les PDF générés aux enregistrements
