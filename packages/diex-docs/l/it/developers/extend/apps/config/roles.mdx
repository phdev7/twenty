...
* I predicati possono fare riferimento a oggetti e campi di proprietà della tua app o degli oggetti standard di Diex.
...
* Vedi un esempio funzionante: [`hello-world/src/roles/function-role.ts`](https://github.com/diexhq/diex/blob/main/packages/diex-apps/hello-world/src/roles/function-role.ts).
