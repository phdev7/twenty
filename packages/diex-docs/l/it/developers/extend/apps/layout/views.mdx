...
* `objectUniversalIdentifier` specifica a quale oggetto si applica questa vista. Può essere un oggetto personalizzato che hai definito o un oggetto Diex standard.
...
Tutti gli enum sopra sono esportati da `diex-sdk/define`.
