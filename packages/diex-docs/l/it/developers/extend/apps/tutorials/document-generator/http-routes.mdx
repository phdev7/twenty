...
e self-hosted, tale percorso è gestito dal tuo server Diex
(ad es. `http://localhost:2020/s/documents/generate`). Su Diex Cloud, `RestApiClient`
...
[Vedi l'helper](https://github.com/diexhq/diex/blob/main/packages/diex-apps/examples/document-generator/src/utils/render-document.ts).
