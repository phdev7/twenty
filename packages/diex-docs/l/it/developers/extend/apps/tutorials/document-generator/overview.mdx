...
description: Crea una vera app Diex che genera documenti personalizzati a partire dai dati del tuo CRM.
---
...
un server Diex locale in esecuzione sulla porta `2020` e la CLI autenticata ad esso.
...
Lascia `yarn diex dev` in esecuzione in un terminale per l’intero tutorial. Ogni volta che
