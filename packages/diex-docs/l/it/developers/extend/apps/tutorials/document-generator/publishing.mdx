...
export default defineApplication({
  ...
  websiteUrl: 'https://docs.diex.com/l/it/developers/extend/apps',
...
Aggiungi anche la parola chiave `diex-app` a `package.json` così l'app è scopribile:
...
su un registro privato di Diex server. Per superficiare un'app pubblicata
