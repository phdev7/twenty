...
description: Scopri i piani tariffari di Diex e come passare da uno all'altro.
---

## Panoramica

Diex offre prezzi flessibili per team di ogni dimensione, sia con hosting cloud sia con self‑hosting.
...
Esegui Diex sulla tua infrastruttura senza costi:
