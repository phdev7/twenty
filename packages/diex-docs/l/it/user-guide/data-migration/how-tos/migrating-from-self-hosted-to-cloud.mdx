...
description: Guida passo-passo per migrare la tua istanza Diex self-hosted verso Diex Cloud.
---

## Panoramica

Questa guida ti accompagna nella migrazione dei tuoi dati da un'istanza Diex self-hosted a Diex Cloud. Il processo prevede la configurazione dello spazio di lavoro cloud, l'esportazione dei dati e la loro reimportazione.
...
1. Vai su [app.diex.com](https://app.diex.com) e crea un nuovo spazio di lavoro
...
<Tip>
  Stai eseguendo la migrazione di uno spazio di lavoro grande o complesso? [Trova un partner Diex certificato](https://diex.com/partners/list?categories=HOSTING\&ref=docs-migrate-cloud) per gestire l’intera migrazione end-to-end. *(Oppure coinvolgi il nostro team: [contact@diex.com](mailto:contact@diex.com).)*
</Tip>
