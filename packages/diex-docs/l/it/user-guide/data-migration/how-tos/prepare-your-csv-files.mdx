...
description: Guida completa passo passo per formattare i tuoi dati per l'importazione in Diex.
---
...
**Questo è il passaggio più importante.** Il file di esempio ti mostra i nomi delle colonne e il formato esatti che Diex si aspetta.
...
Diex impone l'unicità su alcuni campi. I duplicati causeranno errori di importazione.
...
3. Verifica la presenza di duplicati già esistenti in Diex
...
* Deve essere univoco (nessun duplicato nel file o in Diex)
...
* Deve essere univoco all'interno del tuo file e in Diex
...
* **Link / Etichetta del link**: `Diex`
* **Link / URL del link**: `https://diex.com`
...
* **Opzionale**: Diex genera automaticamente gli ID se non forniti
...
* Il record padre deve già esistere in Diex
...
## Passaggio 6: Verifica che i campi esistano in Diex
