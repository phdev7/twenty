...
description: Segui una guida passo passo su come registrarti su Diex, scegliere un piano di abbonamento e configurare il tuo account.
---
...
1. Vai a [Registrati su Diex](https://app.diex.com).
...
Per domande o aiuto, contatta il team di supporto dedicato a [contact@diex.com](mailto:contact@diex.com) o invia un messaggio su [Discord](https://discord.gg/cx5n4Jzs57).
