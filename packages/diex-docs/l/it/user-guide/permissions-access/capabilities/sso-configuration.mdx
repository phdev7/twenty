...
Il Single Sign-On (SSO) consente ai membri del tuo team di accedere a Diex utilizzando il provider di identità della tua organizzazione. Questo offre:
...
* Accesso amministratore allo spazio di lavoro Diex

<Note>
**Per gli utenti self-hosting che desiderano configurare l'SSO**, contatta contact@diex.com
</Note>
...
* Rimuovili dallo spazio di lavoro Diex
...
* **Mappatura dei gruppi**: Mappa i gruppi IdP ai ruoli di Diex (se disponibile)
* **Processo di offboarding**: Includi Diex nel tuo flusso di lavoro di deprovisioning
...
<Tip>
  Hai bisogno di configurare l’SSO per la tua organizzazione? [Trova un partner Diex certificato](https://diex.com/partners/list?categories=SOLUTIONING\&ref=docs-sso) specializzato in SSO e configurazione dell’identità. *(Preferisci coinvolgere direttamente Diex? [contact@diex.com](mailto:contact@diex.com).)*
</Tip>
