...
description: Domande frequenti sulle impostazioni di Diex.
---
...
Per modificare il tuo indirizzo email, contatta [contact@diex.com](mailto:contact@diex.com).
</Accordion>
...
* **Sottodominio**: usa un sottodominio di Diex come `yourcompany.diex.com`
