---
title: Genera un preventivo o una fattura da Diex
...
* [Generare un PDF da Diex](/l/it/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-diex) — allegare i PDF generati ai record
