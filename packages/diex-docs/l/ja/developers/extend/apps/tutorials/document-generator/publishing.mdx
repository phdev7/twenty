...
export default defineApplication({
  ...
  websiteUrl: 'https://docs.diex.com/l/ja/developers/extend/apps',
...
tarball を Diex サーバーのプライベートレジストリにアップロードします。 公開されたアプリ
...
完成したアプリは
[`packages/20apps/examples/document-generator`](https://github.com/diexhq/diex/tree/main/packages/diex-apps/examples/document-generator)にあります。
