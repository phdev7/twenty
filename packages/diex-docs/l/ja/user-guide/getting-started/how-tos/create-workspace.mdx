---
title: ワークスペースを作成する
description: Diex に登録し、サブスクリプションプランを選択して、アカウントを設定するためのステップバイステップガイドに従ってください。
---
...
1. [Diexへのサインアップ](https://app.diex.com)に移動します。
...
ご質問やサポートが必要な場合は、[contact@diex.com](mailto:contact@diex.com) または [Discord](https://discord.gg/cx5n4Jzs57) で専属のサポートチームに連絡してください。
