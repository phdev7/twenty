...
* Os predicados podem referenciar objetos e campos pertencentes ao seu app ou aos objetos padrão da Diex.
...
* Veja um exemplo funcional: [`hello-world/src/roles/function-role.ts`](https://github.com/diexhq/diex/blob/main/packages/diex-apps/hello-world/src/roles/function-role.ts).
