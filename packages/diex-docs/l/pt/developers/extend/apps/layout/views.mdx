...
* `objectUniversalIdentifier` especifica a qual objeto esta visualização se aplica. Pode ser um objeto personalizado que você definiu ou um objeto padrão do Diex.
...
Todos os enums acima são exportados de `diex-sdk/define`.
