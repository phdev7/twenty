...
description: Crie um aplicativo Diex real que gera documentos personalizados a partir dos seus dados de CRM.
---
...
um servidor Diex local em execução na porta `2020` e o CLI autenticado nele.
...
Deixe `yarn diex dev` rodando em um terminal durante todo o tutorial. Toda vez que
