...
description: Saiba mais sobre os planos de preços do Diex e como alternar entre eles.
---

## Visão Geral

O Diex oferece preços flexíveis para atender equipes de todos os tamanhos, quer você prefira hospedagem em nuvem ou auto-hospedagem.
...
Hospede o Diex na sua própria infraestrutura sem custo:
