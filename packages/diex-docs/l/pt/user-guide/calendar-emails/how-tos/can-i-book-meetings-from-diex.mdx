---
title: Posso agendar reuniões a partir do Diex?
description: Informações sobre o agendamento de reuniões diretamente a partir do Diex.
---

## Estado atual

A integração de calendário do Diex foi concebida para **sincronizar e apresentar** os seus eventos de calendário existentes.

## Agendamento de reuniões através de Fluxos de Trabalho

Embora não seja possível agendar reuniões manualmente, pode fazê-lo no Diex utilizando Fluxos de Trabalho
