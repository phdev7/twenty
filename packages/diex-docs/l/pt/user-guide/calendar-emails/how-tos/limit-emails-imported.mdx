...
description: Controle quais emails são importados para o Diex.
---

## Visão Geral

Por padrão, o Diex sincroniza todos os emails externos da sua caixa de correio conectada. Você pode limitar o que é importado usando **seleção de pastas** e **configurações de visibilidade**.
...
Mensagens entre colegas (mesmo domínio) podem ser sincronizadas no Diex:
