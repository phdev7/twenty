---
title: Painéis
description: Aprenda o básico sobre relatórios e painéis no Diex.
---
...
Os painéis no Diex oferecem uma forma visual de acompanhar suas principais métricas de desempenho e obter insights dos seus dados de CRM.
...
<Note>
**Limitações atuais**:
* A exportação de painéis e o compartilhamento com usuários externos (usuários não-Diex) não estão disponíveis no momento.
