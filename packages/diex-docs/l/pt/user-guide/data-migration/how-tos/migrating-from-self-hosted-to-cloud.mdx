...
description: Guia passo a passo para migrar a sua instância Diex auto-hospedada para a Diex Cloud.
---

## Visão Geral

Este guia orienta-o na migração dos seus dados de uma instância Diex auto-hospedada para a Diex Cloud. O processo envolve configurar o seu espaço de trabalho na cloud, exportar os seus dados e voltar a importá-los.
...
1. Aceda a [app.diex.com](https://app.diex.com) e crie um novo espaço de trabalho
...
<Tip>
  Migrando um espaço de trabalho grande ou complexo? [Encontre um parceiro Diex certificado](https://diex.com/partners/list?categories=HOSTING\&ref=docs-migrate-cloud) para cuidar da migração de ponta a ponta. *(Ou envolva a nossa equipe: [contact@diex.com](mailto:contact@diex.com).)*
</Tip>
