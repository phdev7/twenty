...
description: Guia completo passo a passo para formatar seus dados para importação no Diex.
---
...
**Esta é a etapa mais importante.** O arquivo de exemplo mostra os nomes exatos das colunas e o formato que o Diex espera.
...
O Diex impõe unicidade em determinados campos. Duplicados causarão erros de importação.
...
3. Verifique se há duplicados que já existem no Diex
...
* Deve ser exclusivo (sem duplicados no arquivo ou no Diex)
...
* Deve ser exclusivo dentro do seu arquivo e no Diex
...
* **Links / Rótulo do Link**: `Diex`
* **Links / URL do Link**: `https://diex.com`
...
* **Opcional**: a Diex gera IDs automaticamente se não forem fornecidos
...
* O registro pai já deve existir na Diex
...
## Etapa 6: Garanta que os campos existam na Diex
