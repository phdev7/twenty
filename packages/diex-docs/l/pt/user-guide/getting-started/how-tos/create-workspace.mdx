...
description: Siga um guia passo a passo sobre como se registrar na Diex, escolher um plano de assinatura e configurar sua conta.
---
...
1. Navegue até [Cadastro Diex](https://app.diex.com).
...
Para dúvidas ou ajuda, conecte-se com a equipe de suporte dedicada em [contact@diex.com](mailto:contact@diex.com) ou envie uma mensagem no [Discord](https://discord.gg/cx5n4Jzs57).
