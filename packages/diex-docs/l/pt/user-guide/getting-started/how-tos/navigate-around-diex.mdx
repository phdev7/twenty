...
O menu de comandos oferece **acesso rápido a ações** no Diex. Você pode acessá-lo de duas maneiras:
...
* Acessar registros excluídos (Diex dá suporte a exclusões lógicas e permanentes)
