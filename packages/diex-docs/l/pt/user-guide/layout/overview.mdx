---
title: Layout
description: Personalize a forma como navega, explora e visualiza registos na Diex.
---

O layout da Diex é personalizável em três níveis: a forma como navega na aplicação, como consulta listas de registos, e o que vê ao abrir um registo individual.
...
As vistas controlam como as listas de registos são apresentadas. A Diex suporta três tipos de vista:
