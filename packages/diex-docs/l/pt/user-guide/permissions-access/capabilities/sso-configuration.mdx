...
O Single Sign-On (SSO) permite que os membros da sua equipe façam login no Diex usando o provedor de identidade da sua organização. Isso oferece:
...
O Diex oferece suporte a SSO com:
...
* Acesso de administrador ao workspace do Diex

<Note>
**Para usuários de auto-hospedagem que desejam configurar SSO**, entre em contato pelo contact@diex.com
</Note>
...
* Remova-os do workspace do Diex
...
* **Mapeamento de grupos**: Mapeie os grupos do IdP para as funções do Diex (se disponível)
* **Processo de desligamento**: Inclua o Diex no seu fluxo de trabalho de desprovisionamento
...
<Tip>
  Precisa de SSO configurado para a sua organização? [Encontre um parceiro Diex certificado](https://diex.com/partners/list?categories=SOLUTIONING\&ref=docs-sso) que seja especialista em SSO e configuração de identidade. *(Prefere envolver a Diex diretamente? [contact@diex.com](mailto:contact@diex.com).)*
</Tip>
