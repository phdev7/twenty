...
description: Perguntas frequentes sobre as configurações do Diex.
---
...
Para alterar seu endereço de e-mail, entre em contato pelo [contact@diex.com](mailto:contact@diex.com).
</Accordion>
...
* **Subdomínio**: Use um subdomínio do Diex como `yourcompany.diex.com`
