---
title: Gerar um orçamento ou fatura no Diex
...
* [Gerar um PDF a partir do Diex](/l/pt/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-diex) — anexar PDFs gerados aos registros
