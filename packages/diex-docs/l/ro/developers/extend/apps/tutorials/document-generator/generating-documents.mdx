...
vezi [`generate-document-input.schema.ts`](https://github.com/diexhq/diex/blob/main/packages/diex-apps/examples/document-generator/src/logic-functions/schemas/generate-document-input.schema.ts).
...
[aplicația pentru înregistrare](https://github.com/diexhq/diex/tree/main/packages/diex-apps/public/call-recorder)
