...
și auto-găzduite, această cale este servită de serverul tău Diex
(de ex. `http://localhost:2020/s/documents/generate`). Pe Diex Cloud, `RestApiClient`
...
sanitizat) şi îl introduce într-o curată, pagina printabilă care afișează doar conținutul șablonului- aceeași imagine ca PDF și previzualizarea in-app.
  [Vezi ajutorul](https://github.com/diexhq/diex/blob/main/packages/diex-apps/examples/document-generator/src/utils/render-document.ts).
