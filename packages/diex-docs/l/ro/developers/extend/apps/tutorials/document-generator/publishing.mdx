...
export default defineApplication({
  ...
  websiteUrl: 'https://docs.diex.com/l/ro/developers/extend/apps',
...
[`pachete/douăzeci de aplicații/exemple/document-generator`](https://github.com/diexhq/diex/tree/main/packages/diex-apps/examples/document-generator).
