...
description: Implementați și gestionați Diex pe propria infrastructură.
---
...
Diex poate fi găzduit în regim propriu pe propria infrastructură, oferindu-vă control complet asupra datelor și a implementării.
