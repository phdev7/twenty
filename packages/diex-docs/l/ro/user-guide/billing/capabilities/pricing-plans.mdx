...
description: Aflați despre planurile tarifare ale Diex și cum să comutați între ele.
---

## Prezentare generală

Diex oferă prețuri flexibile care se potrivesc echipelor de orice dimensiune, fie că preferați găzduirea în cloud sau autogăzduirea.
...
Găzduiți Diex pe propria infrastructură, fără costuri:
...
* **Funcționalități Premium**: integrare SSO, permisiuni la nivel de rând, date privind utilizarea AI și altele
* Asistență din partea echipei Diex
