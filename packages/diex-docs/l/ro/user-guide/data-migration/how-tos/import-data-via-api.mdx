...
description: Când și cum să utilizați API-urile Diex pentru importuri de date la scară mare.
---

## Prezentare generală

Diex oferă atât **GraphQL**, cât și **API-uri REST** pentru importul programatic de date. Utilizați API-ul când importul CSV nu este practic pentru volumul dvs. de date sau când aveți nevoie de importuri automate, recurente.
...
Diex impune limitări de rată pentru a asigura stabilitatea sistemului:
...
Diex acceptă două tipuri de API:
...
* Verificați că formatele corespund cerințelor Diex (consultați [Maparea câmpurilor](/l/ro/user-guide/data-migration/capabilities/field-mapping))
...
* Verificați că datele apar corect în Diex
...
Contactați-ne la [contact@diex.com](mailto:contact@diex.com) sau explorați [Serviciile noastre de implementare](/l/ro/user-guide/getting-started/capabilities/implementation-services).
