...
description: Ghid pas cu pas pentru migrarea datelor din orice CRM către Diex.
---

## Prezentare generală

Acest ghid vă ghidează prin procesul de migrare a datelor din orice CRM către Diex. Procesul implică auditarea datelor, pregătirea spațiului de lucru Diex, exportul din sistemul curent și importul în Diex.
...
Creați un document de mapare între CRM-ul curent și Diex:
...
## Pasul 3: Configurați spațiul dvs. de lucru Diex

Înainte de a importa date, pregătiți spațiul dvs. de lucru Diex:
...
Dacă datele dvs. includ referințe la utilizatori (Proprietar cont, Atribuit etc.), acei utilizatori trebuie să existe în Diex înainte de import. În caz contrar, acele relații nu pot fi mapate.
</Warning>
...
Deschideți fiecare CSV exportat într-o aplicație de calcul tabelar și pregătiți-l pentru Diex.
...
3. Verificați că nu există deja duplicate în Diex
...
Folosiți `https://domain.com` (nu `domain.com` sau `www.domain.com`). Acest lucru corespunde formatului Diex și previne duplicatele când conectați sincronizarea e-mailului/calendarului.
</Warning>
...
2. Folosiți aceleași adrese de e-mail pe care utilizatorii le-au folosit pentru a se alătura spațiului dvs. de lucru Diex
...
* Diex va începe să sincronizeze e-mailurile cu înregistrările de contact
...
<AccordionGroup>
  <Accordion title="Pot migra fluxurile de lucru automat?">
    Momentan, nu. Fluxurile de lucru trebuie recreate manual în Diex.
  </Accordion>
...
<Tip>
  ...
  * **Realizat pentru tine:** [găsește un partener Diex certificat](https://diex.com/partners/list?categories=SOLUTIONING\&ref=docs-migrate-crm) care să îți mute datele, pipeline-urile și utilizatorii de la un capăt la altul.
  * **Pachet de onboarding:** o configurare asistată de 4 ore împreună cu echipa noastră — [contact@diex.com](mailto:contact@diex.com).
</Tip>
