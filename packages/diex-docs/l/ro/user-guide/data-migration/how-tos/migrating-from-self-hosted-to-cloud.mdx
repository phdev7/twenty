...
description: Ghid pas cu pas pentru migrarea instanței Diex auto-găzduite la Diex Cloud.
---

## Prezentare generală

Acest ghid vă ghidează prin migrarea datelor dvs. dintr-o instanță Diex auto-găzduită către Diex Cloud. Procesul presupune configurarea spațiului dvs. de lucru în cloud, exportarea datelor și reimportarea acestora.
...
1. Accesați [app.diex.com](https://app.diex.com) și creați un nou spațiu de lucru
...
<Tip>
  Migrați un spațiu de lucru mare sau complex? [Găsiți un partener Diex certificat](https://diex.com/partners/list?categories=HOSTING\&ref=docs-migrate-cloud) care să gestioneze migrarea de la un capăt la altul. *(Sau implicați echipa noastră: [contact@diex.com](mailto:contact@diex.com).)*
</Tip>
