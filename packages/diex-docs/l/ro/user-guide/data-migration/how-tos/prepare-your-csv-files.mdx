...
description: Ghid complet, pas cu pas, pentru a formata datele pentru import în Diex.
---
...
**Acesta este cel mai important pas.** Fișierul de mostră vă arată exact denumirile de coloane și formatul pe care îl așteaptă Diex.
...
Diex impune unicitatea pentru anumite câmpuri. Valorile duplicate vor provoca erori la import.
...
3. Verificați duplicatele care există deja în Diex
...
* Trebuie să fie unic (fără duplicate în fișier sau în Diex)
...
* Trebuie să fie unic în fișierul dvs. și în Diex
...
* **Linkuri / Etichetă link**: `Diex`
* **Linkuri / URL link**: `https://diex.com`
...
* **Opțional**: Diex generează automat ID-uri dacă nu sunt furnizate
...
* Înregistrarea părinte trebuie să existe deja în Diex
...
## Pasul 6: Asigurați-vă că câmpurile există în Diex
