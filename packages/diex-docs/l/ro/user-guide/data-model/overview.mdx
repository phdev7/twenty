...
Fiecare afacere funcționează diferit. Personalizarea modelului tău de date înseamnă că poți modela Diex în jurul proceselor **tale**, în loc să le forțezi într-un sistem rigid.

Diex oferă flexibilitate totală:
...
Identifică principalele concepte cu care lucrezi. Diex oferă deja:
...
<Tip>
  ...
  * **Realizat pentru tine:** [găsește un partener Diex certificat](https://diex.com/partners/list?categories=SOLUTIONING\&ref=docs-data-model) care să îți proiecteze și să îți construiască obiectele, câmpurile și relațiile.
  * **Pachet de onboarding:** o sesiune ghidată de 4 ore pentru proiectarea modelului de date, împreună cu echipa noastră — [contact@diex.com](mailto:contact@diex.com). Vezi [Serviciile de implementare](/l/ro/user-guide/getting-started/capabilities/implementation-services).
</Tip>
