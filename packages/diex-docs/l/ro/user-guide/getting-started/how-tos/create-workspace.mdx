...
description: Urmați un ghid pas cu pas despre cum să vă înregistrați pe Diex, să alegeți un plan de abonament și să vă configurați contul.
---
...
1. Navigați la [Diex Sign Up](https://app.diex.com).
...
Pentru întrebări sau ajutor, contactați echipa de suport dedicată la [contact@diex.com](mailto:contact@diex.com) sau trimiteți un mesaj pe [Discord](https://discord.gg/cx5n4Jzs57).
