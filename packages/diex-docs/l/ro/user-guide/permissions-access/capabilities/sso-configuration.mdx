...
Single Sign-On (SSO) le permite membrilor echipei dvs. să se autentifice în Diex folosind furnizorul de identitate al organizației dvs. Acest lucru oferă:
...
* Acces de administrator la spațiul de lucru Diex

<Note>
**Pentru utilizatorii care se auto-găzduiesc și doresc să configureze SSO**, contactați contact@diex.com
</Note>
...
* Eliminați-i din spațiul de lucru Diex
...
* **Maparea grupurilor**: Mapați grupurile IdP la rolurile Diex (dacă este disponibilă)
* **Proces de offboarding**: Includeți Diex în fluxul dvs. de deprovisionare
...
<Tip>
  Aveți nevoie de configurarea SSO pentru organizația dvs.? [Găsiți un partener Diex certificat](https://diex.com/partners/list?categories=SOLUTIONING\&ref=docs-sso) specializat în SSO și configurarea identității. *(Preferiți să implicați Diex direct? [contact@diex.com](mailto:contact@diex.com).)*
</Tip>
