...
description: Întrebări frecvente despre setările Diex.
---
...
Pentru a vă schimba adresa de e-mail, vă rugăm să ne contactați la [contact@diex.com](mailto:contact@diex.com).
</Accordion>
...
* **Subdomeniu**: Folosiți un subdomeniu Diex, de exemplu `yourcompany.diex.com`
