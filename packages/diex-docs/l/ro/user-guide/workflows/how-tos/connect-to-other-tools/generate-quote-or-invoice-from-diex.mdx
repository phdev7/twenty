---
title: Generați o ofertă sau o factură din Diex
...
* [Generați un PDF din Diex](/l/ro/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-diex) — atașați PDF-uri generate la înregistrări
