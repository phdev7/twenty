...
* Предикаты могут ссылаться на объекты и поля, принадлежащие вашему приложению, или на стандартные объекты и поля Diex.
...
* См. рабочий пример: [`hello-world/src/roles/function-role.ts`](https://github.com/diexhq/diex/blob/main/packages/diex-apps/hello-world/src/roles/function-role.ts).
