...
description: Diex'nin açık kaynak geliştirmesine katkıda bulunun.
---
...
Diex açık kaynaktır ve topluluktan gelen katkıları memnuniyetle karşılar. İster hataları düzeltiyor, ister özellikler ekliyor ya da belgeleri iyileştiriyor olun, katkılarınız Diex'yi herkes için daha iyi hâle getirmeye yardımcı olur.
