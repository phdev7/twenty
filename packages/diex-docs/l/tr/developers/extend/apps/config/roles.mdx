...
* Koşullar, uygulamanıza ait nesnelere ve alanlara veya Diex'nin standart nesnelerine başvurabilir.
...
* Çalışan bir örnek için bkz.: [`hello-world/src/roles/function-role.ts`](https://github.com/diexhq/diex/blob/main/packages/diex-apps/hello-world/src/roles/function-role.ts).
