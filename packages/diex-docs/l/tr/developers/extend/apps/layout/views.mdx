...
* `objectUniversalIdentifier`, bu görünümün hangi nesneye uygulanacağını belirtir. Bu, tanımladığınız özel bir nesne veya standart bir Diex nesnesi olabilir.
...
Yukarıdaki tüm enum'lar `diex-sdk/define` içinden dışa aktarılır.
