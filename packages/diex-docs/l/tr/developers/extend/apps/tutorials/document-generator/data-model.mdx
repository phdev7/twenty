...
`RICH_TEXT` alanıdır, bu nedenle Diex ona tam özellikli bir zengin metin düzenleyicisi verir.
...
[`document.object.ts`](https://github.com/diexhq/diex/blob/main/packages/diex-apps/examples/document-generator/src/objects/document.object.ts).
...
`yarn diex dev` çalışırken **Settings → Data model** bölümünü açın. Her iki nesne de
