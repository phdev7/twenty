...
| UI uzantılarına sahip Diex Uygulaması             | [Uygulamalar](/l/tr/developers/extend/apps/getting-started) (OAuth otomatik olarak yönetilir) |

## Bir İstemci Kaydedin

Diex, [RFC 7591](https://datatracker.ietf.org/doc/html/rfc7591) uyarınca **dinamik istemci kaydını** destekler. Manuel kurulum gerekmez — programatik olarak kaydedin:
...
Uygulamanız bir Diex kullanıcısı adına hareket ettiğinde bu akışı kullanın.
...
Yetkilendirmeden sonra, Diex `redirect_uri` adresinize geri yönlendirir:
...
Diex, OAuth yapılandırmasını standart bir keşif uç noktasında yayımlar:
