...
description: Diex’yi bulutta veya kendi sunucunuzda 5 dakikadan kısa sürede çalışır hâle getirin.
icon: play
---
...
<Steps>
  <Step title="Hesabınızı oluşturun">
    [app.diex.com](https://app.diex.com) adresine gidin ve Google, Microsoft veya e-posta ile kayıt olun.
  </Step>
...
İçeri girdikten sonra, Diex'yi size özel kılmak için üç adım:

### 1. Posta kutunuzu bağlayın

**Ayarlar → Hesaplar**'a gidin ve Google veya Microsoft hesabınızı bağlayın. Diex, e-postalarınızı ve takvim etkinliklerinizi içe aktaracak ve etkileşimlerden otomatik olarak kişiler oluşturacaktır. Başka bir sağlayıcı mı kullanıyorsunuz? Aynı sayfadan SMTP üzerinden posta kutuları veya CalDAV üzerinden takvimler ekleyebilirsiniz.
