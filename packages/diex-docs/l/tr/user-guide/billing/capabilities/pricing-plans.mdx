...
description: Diex'nin fiyatlandırma planlarını ve bunlar arasında nasıl geçiş yapacağınızı öğrenin.
---

## Genel Bakış

İster bulut barındırma ister kendi kendine barındırmayı tercih edin, Diex her ölçekte ekibe uyacak esnek fiyatlandırma sunar.
...
Diex'yi kendi altyapınızda hiçbir ücret ödemeden barındırın:
