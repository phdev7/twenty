---
title: Posta Kutusu
description: Diex'deki e-posta entegrasyonu özelliklerini anlama.
---
...
Diex, bağlı posta kutularınızdaki e-postaları ilgili CRM kayıtlarına otomatik olarak bağlar, tüm iletişim geçmişini tek bir yerde tutar.
...
Diex e-postaları yaklaşık olarak dakikada **400 ileti** hızında içe aktarır. Bu hız şu anda Gmail API hız sınırlaması tarafından kısıtlanmaktadır (ve benzer şekilde diğer sağlayıcılar için de geçerlidir).
...
Diex içinde dahili e-postaların senkronize edilip edilmeyeceğini seçin:
...
* **Eksik Mailler**: Şu durumları kontrol edin:
  ...
  * Otomatik kişi oluşturma devre dışı (e-postaların zaten var olan Diex kayıtlarına ihtiyacı var)
