...
description: Büyük ölçekli veri içe aktarmaları için Diex'nin API'lerini ne zaman ve nasıl kullanacağınız.
---

## Genel Bakış

Diex, programatik veri içe aktarma için hem **GraphQL** hem de **REST API'leri** sunar. Veri hacminiz için CSV içe aktarma pratik değilse veya otomatik, yinelenen içe aktarmalara ihtiyacınız varsa API'yi kullanın.
...
Diex, sistem kararlılığını sağlamak için hız sınırlarını uygular:
...
* Biçimlerin Diex'nin gereksinimlerine uyduğunu doğrulayın (bkz. [Alan Eşleme](/l/tr/user-guide/data-migration/capabilities/field-mapping))
...
* Verilerin Diex'de doğru göründüğünü doğrulayın
...
[contact@diex.com](mailto:contact@diex.com) adresinden bizimle iletişime geçin veya [Uygulama Hizmetlerimizi](/l/tr/user-guide/getting-started/capabilities/implementation-services) keşfedin.
