...
description: Verilerinizi herhangi bir CRM'den Diex'ye taşımak için adım adım kılavuz.
---

## Genel Bakış

Bu kılavuz, verilerinizi herhangi bir CRM'den Diex'ye taşıma sürecinde size yol gösterir. Süreç, verilerinizi denetlemeyi, Diex çalışma alanınızı hazırlamayı, mevcut sisteminizden dışa aktarmayı ve Diex'ye içe aktarmayı içerir.
...
Mevcut CRM'iniz ile Diex arasında bir eşleme belgesi oluşturun:
...
## Adım 3: Diex Çalışma Alanınızı Kurun

Verileri içe aktarmadan önce Diex çalışma alanınızı hazırlayın:
...
Verileriniz kullanıcı referansları içeriyorsa (Hesap Sahibi, Atanan vb.), bu kullanıcıların içe aktarmadan önce Diex'de mevcut olması gerekir. Aksi halde bu ilişkiler eşlenemez.
</Warning>
...
Dışa aktarılan her CSV'yi bir hesap tablosu uygulamasında açın ve Diex için hazırlayın.
...
3. Diex'de halihazırda yinelenen olmadığını doğrulayın
...
`https://domain.com` kullanın (`domain.com` veya `www.domain.com` değil). Bu, Diex'nin biçimiyle eşleşir ve e-posta/takvim eşzamanlamasını bağladığınızda yinelenmeleri önler.
</Warning>
...
2. Kullanıcıların Diex çalışma alanınıza katılmak için kullandıklarıyla aynı e-posta adreslerini kullanın
...
* Diex, e-postaları kişi kayıtlarıyla eşzamanlamaya başlayacaktır
...
<AccordionGroup>
  <Accordion title="İş akışlarını otomatik olarak taşıyabilir miyim?">
    Şu anda mümkün değil. İş akışları Diex'de manuel olarak yeniden oluşturulmalıdır.
  </Accordion>
...
<Tip>
  ...
  * **Sizin yerinize yapılır:** verilerinizi, pipeline'larınızı ve kullanıcılarınızı uçtan uca taşımak için [sertifikalı bir Diex iş ortağı bulun](https://diex.com/partners/list?categories=SOLUTIONING\&ref=docs-migrate-crm).
  * **Oryantasyon paketi:** ekibimizle 4 saatlik rehberli kurulum — [contact@diex.com](mailto:contact@diex.com).
</Tip>
