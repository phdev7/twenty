...
description: Diex kendi barındırmalı örneğinizi Diex Cloud’a taşımak için adım adım kılavuz.
---

## Genel Bakış

Bu kılavuz, verilerinizi Diex kendi barındırmalı örneğinizden Diex Cloud’a taşıma sürecinde size adım adım yol gösterir. Süreç; bulut çalışma alanınızı kurmayı, verilerinizi dışa aktarmayı ve yeniden içe aktarmayı içerir.
...
1. [app.diex.com](https://app.diex.com) adresine gidin ve yeni bir çalışma alanı oluşturun
...
<Tip>
  Büyük veya karmaşık bir çalışma alanını mı taşıyorsunuz? Taşıma sürecinin başından sonuna kadar yönetilmesi için [sertifikalı bir Diex iş ortağı edinin](https://diex.com/partners/list?categories=HOSTING\&ref=docs-migrate-cloud). *(Veya ekibimizi de sürece dahil edin: [contact@diex.com](mailto:contact@diex.com).)*
</Tip>
