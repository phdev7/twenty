...
Tek Oturum Açma (SSO), ekip üyelerinizin kuruluşunuzun kimlik sağlayıcısını kullanarak Diex'ye giriş yapmasına olanak tanır. Bu şunları sağlar:
...
Diex, SSO'yu şu sağlayıcılarla destekler:
...
* Diex çalışma alanına yönetici erişimi

<Note>
**SSO'yu kurmak isteyen öz barındırma kullanıcıları için**, contact@diex.com ile iletişime geçin
</Note>
...
* Diex çalışma alanından kaldırın
...
* **Grup eşleme**: IdP gruplarını Diex rollerine eşleyin (varsa)
* **Ayrılış süreci**: Erişim kaldırma iş akışınıza Diex'yi dahil edin
...
<Tip>
  Kuruluşunuz için SSO yapılandırılması mı gerekiyor? SSO ve kimlik kurulumunda uzmanlaşmış [sertifikalı bir Diex iş ortağı bulun](https://diex.com/partners/list?categories=SOLUTIONING\&ref=docs-sso). *(Diex'yi doğrudan sürece dahil etmeyi mi tercih edersiniz? [contact@diex.com](mailto:contact@diex.com).)*
</Tip>
