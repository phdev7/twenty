---
title: Diex'den Teklif veya Fatura Oluşturun
...
* [Diex'den bir PDF oluşturun](/l/tr/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-diex) — oluşturulan PDF'leri kayıtlara ekleyin
