...
export default defineApplication({
  ...
  websiteUrl: 'https://docs.diex.com/l/zh/developers/extend/apps',
...
已完成的应用位于
[\`软件包/二十个应用/示例/文件生成器'](https://github.com/diexhq/diex/tree/main/packages/diex-apps/examples/document-generator)。
