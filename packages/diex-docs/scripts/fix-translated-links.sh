...
if [ -d "packages/diex-docs" ]; then
  DOCS_DIR="packages/diex-docs/l"
elif [ -d "l" ]; then
  DOCS_DIR="l"
else
...
for lang_dir in "$DOCS_DIR"/*/ ; do
  ...
  find "$lang_dir" -name "*.mdx" -type f -exec sed -i.bak \
    "s|href=\"/diex-ui/|href=\"/l/$lang_code/diex-ui/|g" {} \;
  ...
  find "$lang_dir" -name "*.mdx" -type f -exec sed -i.bak \
    "s|](/diex-ui/|](/l/$lang_code/diex-ui/|g" {} \;

  find "$lang_dir" -name "*.mdx" -type f -exec sed -i.bak \
    "s|https://docs\.diex\.com/getting-started/|https://docs.diex.com/l/$lang_code/getting-started/|g" {} \;
  find "$lang_dir" -name "*.mdx" -type f -exec sed -i.bak \
    "s|https://docs\.diex\.com/user-guide/|https://docs.diex.com/l/$lang_code/user-guide/|g" {} \;
  find "$lang_dir" -name "*.mdx" -type f -exec sed -i.bak \
    "s|https://docs\.diex\.com/developers/|https://docs.diex.com/l/$lang_code/developers/|g" {} \;
  find "$lang_dir" -name "*.mdx" -type f -exec sed -i.bak \
    "s|https://docs\.diex\.com/diex-ui/|https://docs.diex.com/l/$lang_code/diex-ui/|g" {} \;
