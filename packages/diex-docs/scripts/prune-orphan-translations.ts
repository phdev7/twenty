...
// Removes orphan localized docs: files under packages/diex-docs/l/<lang>/**
...
//
// Usage:
//   tsx packages/diex-docs/scripts/prune-orphan-translations.ts
//   tsx packages/diex-docs/scripts/prune-orphan-translations.ts --apply
...
const main = (): void => {
  if (!fs.existsSync(LOCALIZED_DIR)) {
    console.log('No localized docs directory (packages/diex-docs/l) — nothing to prune.');
    return;
  }
