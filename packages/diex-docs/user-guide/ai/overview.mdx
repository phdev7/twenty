---
title: AI
description: AI-powered features in Diex.
---
...
Currently, Diex offers:

### 1. AI Chatbot

A conversational assistant that understands your context and has access to all your Diex data.

**Key capabilities:**
- **Full data access**: Query any record, relationship, or metric in your workspace
- **Page context awareness**: Reference "this company" or "this opportunity" based on where you are in Diex
...
- Follow our [GitHub](https://github.com/diexhq/diex) for development updates
