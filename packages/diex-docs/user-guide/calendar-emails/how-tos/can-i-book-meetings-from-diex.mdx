---
title: Can I Book Meetings from Diex?
description: Information about booking meetings directly from Diex.
---

## Current Status

Diex's calendar integration is designed to **sync and display** your existing calendar events.

## Scheduling Meetings via Workflows

While it's not possible to schedule meetings manually, you can do them in Diex using workflows
