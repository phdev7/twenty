...
description: When and how to use Diex's APIs for large-scale data imports.
---

## Overview

Diex provides both **GraphQL** and **REST APIs** for programmatic data import. Use the API when CSV import isn't practical for your data volume or when you need automated, recurring imports.
...
Diex enforces rate limits to ensure system stability:
...
- Verify formats match Diex's requirements (see [Field Mapping](/user-guide/data-migration/capabilities/field-mapping))
...
- Verify data appears correctly in Diex
...
Contact us at [contact@diex.com](mailto:contact@diex.com) or explore our [Implementation Services](/user-guide/getting-started/capabilities/implementation-services).
