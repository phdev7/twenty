...
description: Step-by-step guide to migrate your Diex self-hosted instance to Diex Cloud.
---

## Overview

This guide walks you through migrating your data from a Diex self-hosted instance to Diex Cloud. The process involves setting up your cloud workspace, exporting your data, and re-importing it.
...
1. Go to [app.diex.com](https://app.diex.com) and create a new workspace
...
<Tip>
  Migrating a large or complex workspace? [Get a certified Diex partner](https://diex.com/partners/list?categories=HOSTING&ref=docs-migrate-cloud) to handle the move end-to-end. *(Or loop in our team: [contact@diex.com](mailto:contact@diex.com).)*
</Tip>
