...
description: Complete step-by-step guide to format your data for import into Diex.
---
...
**This is the most important step.** The sample file shows you the exact column names and format Diex expects.
...
Diex enforces uniqueness on certain fields. Duplicates will cause import errors.
...
3. Check for duplicates that already exist in Diex
...
- Must be unique (no duplicates in file or in Diex)
...
- Must be unique within your file and in Diex
...
### ID Fields
- **Optional**: Diex auto-generates IDs if not provided
...
- The parent record must already exist in Diex
...
## Step 6: Ensure Fields Exist in Diex
