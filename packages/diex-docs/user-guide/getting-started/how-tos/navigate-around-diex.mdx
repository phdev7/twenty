...
The command menu gives you **quick access to actions** in Diex. You can access it in two ways:
...
- Create new views
- Access deleted records (Diex supports soft and hard deletes)
