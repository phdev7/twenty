...
Single Sign-On (SSO) allows your team members to log into Diex using your organization's identity provider. This provides:
...
- Admin access to Diex workspace

<Note>
**For self-hosting users willing to set up SSO**, reach out to contact@diex.com
</Note>
...
- Remove them from the Diex workspace
...
- **Group mapping**: Map IdP groups to Diex roles (if available)
- **Offboarding process**: Include Diex in your deprovisioning workflow
...
<Tip>
  Need SSO configured for your organization? [Find a certified Diex partner](https://diex.com/partners/list?categories=SOLUTIONING&ref=docs-sso) who specializes in SSO and identity setup. *(Prefer to loop in Diex directly? [contact@diex.com](mailto:contact@diex.com).)*
</Tip>
