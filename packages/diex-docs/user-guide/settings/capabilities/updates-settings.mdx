...
description: Enable Early Access features in Diex.
---
...
<Note>
Early Access features may change based on user feedback. Your input helps us improve Diex!
</Note>

## Feature Feedback

Your feedback helps improve Diex:
