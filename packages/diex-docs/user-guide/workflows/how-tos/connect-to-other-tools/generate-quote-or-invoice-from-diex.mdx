---
title: Generate a Quote or Invoice from Diex
...
- [Generate a PDF from Diex](/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-diex) — attach generated PDFs to records
