...
import { WhatIsDiex } from 'src/components/WhatIsDiex';
...
export const SendInviteLinkEmail = ({
  ...
  return (
    <BaseEmail width={333} locale={locale}>
      <Title value={i18n._('Join your team on Diex CRM')} />
      <MainText>
        <Trans
      ...
      <WhatIsDiex i18n={i18n} />
    </BaseEmail>
  );
};

SendInviteLinkEmail.PreviewProps = {
  link: 'https://app.crm.bydiex.com/invite/123',
  workspace: {
    name: 'Acme Inc.',
