...
import { APP_LOCALES } from 'diex-shared/translations';
import { defineConfig, type Plugin } from 'vite';

// diex-emails bundles its deps (the Node server that consumes it doesn't have
...
export default defineConfig({
  root: __dirname,
  cacheDir: '../../node_modules/.vite/packages/diex-emails',
