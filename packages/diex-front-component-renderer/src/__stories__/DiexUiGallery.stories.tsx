...
const meta: Meta<typeof FrontComponentRenderer> = {
  title: 'FrontComponent/Diex UI Gallery',
...
export const IconReact: Story = createGalleryStory('diex-ui-icon-gallery');
export const IconPreact: Story = createGalleryStory(
  'diex-ui-icon-gallery',
  'preact',
);
...
export const JsonVisualizerReact: Story = createKnownFailureGalleryStory(
  'diex-ui-json-visualizer-gallery',
...
export const ModalOpenReact: Story = {
  ...createGalleryStory('diex-ui-modal-open-gallery'),
  play: modalOpenHangTest,
};
export const ModalOpenPreact: Story = {
  ...createGalleryStory('diex-ui-modal-open-gallery', 'preact'),
  play: modalOpenTest,
};
...
export const CodeEditorReact: Story = {
  ...createGalleryStory('diex-ui-code-editor-gallery'),
  play: codeEditorTest,
};
export const CodeEditorPreact: Story = {
  ...createGalleryStory('diex-ui-code-editor-gallery', 'preact'),
  play: codeEditorTest,
};

export const TypographyReact: Story = createGalleryStory(
  'diex-ui-typography-gallery',
);
