...
const diexUiTest: Story['play'] = async ({ canvasElement }) => {
  const canvas = within(canvasElement);

  await canvas.findByTestId('diex-ui-component', {}, { timeout: 30000 });
...
export const DiexUiReact: Story = createComponentStory('diex-ui-example', {
  play: diexUiTest,
});
export const DiexUiPreact: Story = createComponentStory('diex-ui-example', {
  runtime: 'preact',
  play: diexUiTest,
});
