...
import { IconStar } from 'diex-ui/icon';
...
export default defineFrontComponent({
  ...
  name: 'diex-ui-data-display-gallery',
  description: 'Renders every diex-ui/data-display component in the sandbox',
