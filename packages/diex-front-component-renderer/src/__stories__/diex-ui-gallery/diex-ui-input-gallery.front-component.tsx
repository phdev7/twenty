...
import { IconPlus, IconSearch, IconStar, IconTrash } from 'diex-ui/icon';
import {
...
const InputGallery = () => (
  <ThemeProvider colorScheme="light">
    <ComponentGallery title="diex-ui/input" entries={INPUT_ENTRIES} />
  </ThemeProvider>
);

export default defineFrontComponent({
  universalIdentifier: 'test-20ui0-0000-0000-0000-000000000107',
  name: 'diex-ui-input-gallery',
  description:
    'Renders every diex-ui/input component (except monaco CodeEditor) in the sandbox',
