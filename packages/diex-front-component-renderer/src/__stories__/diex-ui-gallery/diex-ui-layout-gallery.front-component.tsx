...
import { IconHeart, IconStar } from 'diex-ui/icon';
import {
...
const LayoutGallery = () => (
  <ThemeProvider colorScheme="light">
    <ComponentGallery title="diex-ui/layout" entries={LAYOUT_ENTRIES} />
  </ThemeProvider>
);

export default defineFrontComponent({
  universalIdentifier: 'test-20ui0-0000-0000-0000-000000000103',
  name: 'diex-ui-layout-gallery',
  description: 'Renders every diex-ui/layout component in the sandbox',
