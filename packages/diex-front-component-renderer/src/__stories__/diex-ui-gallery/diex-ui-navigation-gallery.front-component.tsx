...
import { IconHome, IconUser } from 'diex-ui/icon';
import {
  ClickToActionLink,
  ContactLink,
  GithubVersionLink,
...
const NAVIGATION_ENTRIES: GalleryEntry[] = [
  ...
  {
    name: 'ContactLink',
    node: <ContactLink href="https://diex.com">Contact</ContactLink>,
  },
  {
  ...
  {
    name: 'RoundedLink',
    node: <RoundedLink href="https://diex.com" label="Rounded link" />,
  },
  {
    name: 'SocialLink',
    node: (
      <SocialLink href="https://twitter.com/diex" type={LinkType.Twitter} />
    ),
  },
  {
...
export default defineFrontComponent({
  ...
  name: 'diex-ui-navigation-gallery',
  description: 'Renders every diex-ui/navigation component in the sandbox',
