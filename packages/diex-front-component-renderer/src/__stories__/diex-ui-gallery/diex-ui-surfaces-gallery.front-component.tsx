...
const SURFACES_ENTRIES: GalleryEntry[] = [
  ...
  // open-Modal known issue is exposed by diex-ui-modal-open-gallery.
  {
    name: 'Modal',
    node: (
...
const SurfacesGallery = () => (
  <ThemeProvider colorScheme="light">
    <ComponentGallery title="diex-ui/surfaces" entries={SURFACES_ENTRIES} />
  </ThemeProvider>
);

export default defineFrontComponent({
  universalIdentifier: 'test-20ui0-0000-0000-0000-000000000105',
  name: 'diex-ui-surfaces-gallery',
  description: 'Renders every diex-ui/surfaces component in the sandbox',
