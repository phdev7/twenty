...
const remoteImageMockHandlers = [
  ...
  http.get('https://diex-icons.com/*', respondWithMockImage),
  http.get('https://diexhq.github.io/*', respondWithMockImage),
  http.get('https://via.placeholder.com/*', respondWithMockImage),
  http.get(
    'https://diex-front-screenshots.s3.eu-west-3.amazonaws.com/*',
