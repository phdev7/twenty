...
import { CoreObjectNameSingular, AppPath } from 'diex-shared/types';
...
import { IconBrowserMaximize } from 'diex-ui/icon';
import { Button } from 'diex-ui/input';
import { getOsControlSymbol } from 'diex-ui/utilities';
