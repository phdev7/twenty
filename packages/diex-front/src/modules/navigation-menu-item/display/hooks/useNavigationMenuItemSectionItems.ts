...
import { filterDiexShellNavigationMenuItems } from '@/navigation-menu-item/common/utils/filterDiexShellNavigationMenuItems';
...
export const useNavigationMenuItemSectionItems = (): NavigationMenuItem[] => {
  ...
  const flatItems = getWorkspaceSidebarOrphanItemsInDisplayOrder({
    workspaceNavigationMenuItems:
      filterDiexShellNavigationMenuItems(workspaceNavigationMenuItems),
    workspaceNavigationMenuItemsSorted: filterDiexShellNavigationMenuItems(
