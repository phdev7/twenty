...
import { AgencyNavigationSection } from '@/agency/components/AgencyNavigationSection';
...
import { DiexNavigationSection } from '@/navigation/components/DiexNavigationSection';
...
export const MainNavigationDrawerNavigationContent = () => {
  ...
  return (
    <StyledScrollableContent>
      <DiexNavigationSection />
      <AgencyNavigationSection />
