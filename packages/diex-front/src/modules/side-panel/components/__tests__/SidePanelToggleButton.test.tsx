...
import { SidePanelPages } from 'diex-shared/types';
import { IconDotsVertical } from 'diex-ui/icon';

const mockAppTooltip = jest.fn();

jest.mock('diex-ui/utilities', () => ({
  useIsMobile: () => false,
  getOsControlSymbol: () => '⌘',
}));

jest.mock('diex-ui/surfaces', () => ({
  ...jest.requireActual('diex-ui/surfaces'),
