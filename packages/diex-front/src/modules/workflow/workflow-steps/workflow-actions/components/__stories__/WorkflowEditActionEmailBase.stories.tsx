...
import { ComponentDecorator, RouterDecorator } from 'diex-ui/testing';
...
const CONFIGURED_SEND_EMAIL_ACTION: WorkflowSendEmailAction = {
  ...
  settings: {
    input: {
      ...
      subject: 'Welcome to Diex!',
      body: 'Dear Tim,\n\nWelcome to Diex! We are excited to have you on board.\n\nBest regards,\nThe Team',
      files: [],
      inReplyTo: '',
    },
    outputSchema: {},
...
export const Configured: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    const emailInput = await canvas.findByText('test@diex.com');
    expect(emailInput).toBeVisible();

    const subjectInput = await canvas.findByText('Welcome to Diex!');
