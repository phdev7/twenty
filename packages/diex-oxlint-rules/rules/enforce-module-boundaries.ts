...
const PACKAGE_TAG_MAP: Record<string, string[]> = {
  'diex-front': ['scope:frontend'],
  'diex-server': ['scope:backend'],
  'diex-ui': ['scope:shared'],
  'diex-shared': ['scope:shared'],
  'diex-emails': ['scope:backend'],
  'diex-sdk': ['scope:sdk', 'scope:shared'],
  'diex-zapier': ['scope:zapier'],
  'diex-oxlint-rules': ['scope:shared'],
  'diex-docs': ['scope:docs'],
  'diex-e2e-testing': ['scope:testing'],
  'create-diex-app': ['scope:create-app'],
};
