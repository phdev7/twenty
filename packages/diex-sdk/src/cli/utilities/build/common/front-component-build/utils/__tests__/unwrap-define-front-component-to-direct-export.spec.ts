...
const INLINE_EXPRESSION_COMPONENT_SOURCE = `import { defineFrontComponent } from 'diex-sdk/define';
...
const IDENTIFIER_COMPONENT_SOURCE = `import { defineFrontComponent } from 'diex-sdk/define';
