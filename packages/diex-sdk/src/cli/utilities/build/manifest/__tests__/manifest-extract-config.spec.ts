...
describe('extractDefineEntity', () => {
  ...
  it('should detect defineField in default export', () => {
    const fileContent = `
      import { defineField } from 'diex-sdk/define';
  ...
  it('should detect defineLogicFunction in default export', () => {
    const fileContent = `
      import { defineLogicFunction } from 'diex-sdk/define';
  ...
  it('should detect defineObject in default export', () => {
    const fileContent = `
      import { defineObject } from 'diex-sdk/define';
  ...
  it('should detect defineRole in default export', () => {
    const fileContent = `
      import { defineRole } from 'diex-sdk/define';
  ...
  it('should detect defineApplicationRole in default export', () => {
    const fileContent = `
      import { defineApplicationRole } from 'diex-sdk/define';
  ...
  it('should not detect non-target function in default export', () => {
    const fileContent = `
      import { someOtherFunction } from 'diex-sdk/define';
