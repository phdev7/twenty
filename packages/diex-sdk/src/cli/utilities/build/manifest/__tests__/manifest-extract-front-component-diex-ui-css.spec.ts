...
describe('extractManifestFromFile - front component importing diex-ui', () => {
  it('extracts the config from a front component that side-effect imports diex-ui/style.css', async () => {
