...
describe('validateConditionalAvailabilityUsage', () => {
  describe('valid usage', () => {
    it('should allow a variable inside a bare conditionalAvailabilityExpression', () => {
      const source = `
        import { defineCommandMenuItem } from 'diex-sdk/define';
        import { objectMetadataItem } from 'diex-sdk/define';
    ...
    it('should allow operators inside the expression', () => {
      const source = `
        import { defineCommandMenuItem } from 'diex-sdk/define';
        import { objectPermissions, everyEquals } from 'diex-sdk/define';
    ...
    it('should not flag same-named helpers imported from diex-shared/utils', () => {
      const source = `
    ...
    it('should not flag Array.prototype.includes property access', () => {
      const source = `
        import { includes } from 'diex-sdk/define';
        import { defineCommandMenuItem } from 'diex-sdk/define';
    ...
    it('should trust files that define an expression (runtime placeholder is the backstop for in-file misuse)', () => {
      const source = `
        import { defineCommandMenuItem } from 'diex-sdk/define';
        import { numberOfSelectedRecords } from 'diex-sdk/define';
    ...
    it('should not flag a type-only import declaration', () => {
      const source = `
        import type { objectMetadataItem } from 'diex-sdk/define';
  ...
  describe('invalid usage', () => {
    ...
    it('should flag an operator called at runtime', () => {
      const source = `
        import { isDefined } from 'diex-sdk/define';
    ...
    it('should flag a variable imported from the diex-sdk root entry', () => {
      const source = `
        import { objectMetadataItem } from 'diex-sdk';
    ...
    it('should flag namespace-import runtime use with no expression', () => {
      const source = `
        import * as sdk from 'diex-sdk/define';
