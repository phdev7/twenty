...
export const CONTAINER_NAME = 'diex-app-dev';
export const TEST_CONTAINER_NAME = 'diex-app-dev-test';
export const IMAGE = 'diexcrm/diex-app-dev:latest';
...
export const getImageForVersion = (version = 'latest'): string => {
  ...
  return `diexcrm/diex-app-dev:${tag}`;
};
