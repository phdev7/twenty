...
// Records credit usage against the running application via the Diex
// server's `/app/billing/charge` endpoint. Reads `DIEX_API_URL` and
// `DIEX_APP_ACCESS_TOKEN` from the execution env (injected by the
