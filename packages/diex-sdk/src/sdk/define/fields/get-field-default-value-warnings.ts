import { type ObjectFieldManifest } from 'diex-shared/application';
import { COMPOSITE_FIELD_TYPE_SUB_FIELDS_NAMES } from 'diex-shared/constants';
import {
  fieldMetadataDefaultValueFunctionName,
  type FieldMetadataDefaultValueFunctionNames,
  FieldMetadataType,
} from 'diex-shared/types';
import { isDefined, isPlainObject } from 'diex-shared/utils';
