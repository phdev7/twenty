...
// stay in `diex-sdk/define` — they are build-time metadata factories that
// the SDK CLI stubs out before bundling. Logic-function source files keep
// importing them from `diex-sdk/define`, but should reach for *types* (and
// future runtime helpers) here, never directly from `diex-shared/*`.
...
export type { ServerRouteDispatchResult } from 'diex-shared/application';
...
export type { RunAgentInput, RunAgentResult } from 'diex-shared/application';

export { kv } from '@/sdk/logic-function/key-value/kv';
export type { AppKeyValue, AppKeyValueScope } from 'diex-shared/application';
