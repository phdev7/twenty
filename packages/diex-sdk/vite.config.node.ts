...
const esmNodeGlobalsBanner = [
  "import { createRequire as __diexCreateRequire } from 'node:module';",
  "import { fileURLToPath as __diexFileURLToPath } from 'node:url';",
  "import { dirname as __diexDirname } from 'node:path';",
  'const require = __diexCreateRequire(import.meta.url);',
  'const __filename = __diexFileURLToPath(import.meta.url);',
  'const __dirname = __diexDirname(__filename);',
].join('\n');
...
export default defineConfig(() => {
  return {
    root: __dirname,
    cacheDir: '../../node_modules/.vite/packages/diex-sdk-node',
    resolve: {
      tsconfigPaths: true,
      alias: {
