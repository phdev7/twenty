import { fromArrayToValuesByKeyRecord, isDefined } from 'diex-shared/utils';
...
// Backfill skips the diex-standard and workspace-custom applications (their GIN index is
...
> => {
  ...
  for (const flatObjectMetadata of Object.values(
    ...
    if (
      flatObjectMetadata.applicationId === diexStandardApplicationId ||
