...
import { getSystemRelationFieldUniversalIdentifier } from 'diex-shared/application';
import {
...
// API transpiler, diex-standard) stamps the reverse morph field with the
...
export class ReconcileSystemRelationFieldUniversalIdentifierCommand extends ProvisionedWorkspaceCommandRunner {
  ...
  override async runOnWorkspace({
    ...
    for (const flatFieldMetadata of Object.values(
      ...
      // for custom objects, by diex-standard for standard ones), so it must
