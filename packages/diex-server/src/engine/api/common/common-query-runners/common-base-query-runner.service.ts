...
> {
  ...
  @Inject()
  protected readonly diexConfigService: DiexConfigService;
  @Inject()
  ...
  private async throttleApplicationQueryExecution(
    ...
    try {
      await this.throttlerService.tokenBucketThrottleOrThrow(
        ...
        1,
        this.diexConfigService.get('APPLICATION_API_RATE_LIMITING_LIMIT'),
        this.diexConfigService.get('APPLICATION_API_RATE_LIMITING_TTL_IN_MS'),
      );
    } catch (error) {
  ...
  private async throttleApiKeyQueryExecution(
    ...
    try {
      ...
      const shortConfig = {
        ...
        maxTokens: this.diexConfigService.get(
          'API_RATE_LIMITING_SHORT_LIMIT',
        ),
        timeWindow: this.diexConfigService.get(
      ...
      const longConfig = {
        ...
        maxTokens: this.diexConfigService.get('API_RATE_LIMITING_LONG_LIMIT'),
        timeWindow: this.diexConfigService.get(
  ...
  private validateQueryComplexity(
    ...
    const maximumComplexity = this.diexConfigService.get(
