...
import { DiexORMException } from 'src/engine/diex-orm/exceptions/diex-orm.exception';
import { diexORMGraphqlApiExceptionHandler } from 'src/engine/diex-orm/utils/diex-orm-graphql-api-exception-handler.util';
...
export const workspaceQueryRunnerGraphqlApiExceptionHandler = (
  ...
  switch (true) {
    ...
    case error instanceof DiexORMException:
      return diexORMGraphqlApiExceptionHandler(error);
