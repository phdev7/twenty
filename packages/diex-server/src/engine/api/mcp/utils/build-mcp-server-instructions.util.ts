...
export const buildMcpServerInstructions = (
  ...
  [
    ...
    `  ARCHITECTURE:     inspect_workspace_architecture | recommend_workspace_blueprint | compare_workspace_blueprint | preview_workspace_change_set | approve_workspace_change_set | apply_workspace_change_set`,
    `                     Object and field mutations must use this governed recommendation, preview, explicit approval, and application flow. Direct metadata mutation tools are unavailable to AI clients.`,
    ...
    `  Data-model changes must remain recommendations until a DATA_MODEL-authorized operator explicitly approves the change set.`,
