...
const DiexConfigServiceGetAllMock = jest.fn();
const DiexConfigServiceGetVariableWithMetadataMock = jest.fn();
const mockHttpClientGet = jest.fn();
const mockGetHttpClient = jest.fn().mockReturnValue({ get: mockHttpClientGet });

jest.mock(
  'src/engine/core-modules/diex-config/constants/config-variables-group-metadata',
  () => ({
...
describe('AdminPanelConfigService', () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        AdminPanelConfigService,
        {
          ...
          useValue: {
            getAll: DiexConfigServiceGetAllMock,
            getVariableWithMetadata:
              DiexConfigServiceGetVariableWithMetadataMock,
          },
        },
      ],
    }).compile();
  ...
  describe('getConfigVariablesGrouped', () => {
    it('should correctly group and sort config variables', () => {
      DiexConfigServiceGetAllMock.mockReturnValue({
        SERVER_URL: {
  ...
  describe('getConfigVariable', () => {
    it('should return config variable with all fields', () => {
      DiexConfigServiceGetVariableWithMetadataMock.mockReturnValue({
        value: 'test-value',
        metadata: {
          group: 'SERVER_CONFIG',
    ...
    it('should throw error when variable not found', () => {
      DiexConfigServiceGetVariableWithMetadataMock.mockReturnValue(undefined);
...
describe('AdminPanelVersionService', () => {
  ...
  describe('getVersionInfo', () => {
    ...
    beforeEach(() => {
      ...
      versionService['diexConfigService'].get = mockEnvironmentGet;
    });
