...
import { ConfigVariableGraphqlApiExceptionFilter } from 'src/engine/core-modules/diex-config/filters/config-variable-graphql-api-exception.filter';
...
export class AdminPanelResolver {
  ...
  async getDatabaseConfigVariable(
    ...
    this.diexConfigService.validateConfigVariableExists(key as string);
  ...
  async createDatabaseConfigVariable(
    ...
    await this.diexConfigService.set(key, value);
  ...
  async updateDatabaseConfigVariable(
    ...
    await this.diexConfigService.update(key, value);
  ...
  async deleteDatabaseConfigVariable(
    ...
    await this.diexConfigService.delete(key);
  ...
  async addAiProvider(
    ...
    const customProviders = {
      ...this.diexConfigService.get('AI_PROVIDERS'),
    };

    customProviders[providerName] = providerConfig;
    await this.diexConfigService.set('AI_PROVIDERS', customProviders);
  ...
  async getAdminAiUsageByWorkspace(
    ...
    const useDollarMode = !this.diexConfigService.get('IS_BILLING_ENABLED');
