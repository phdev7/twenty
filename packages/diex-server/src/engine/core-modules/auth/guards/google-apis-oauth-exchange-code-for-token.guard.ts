...
export class GoogleAPIsOauthExchangeCodeForTokenGuard extends AuthGuard(
  ...
  async canActivate(context: ExecutionContext) {
    try {
      ...
      if (
        !this.diexConfigService.get('MESSAGING_PROVIDER_GMAIL_ENABLED') &&
        !this.diexConfigService.get('CALENDAR_PROVIDER_GOOGLE_ENABLED')
      ) {
      ...
      new GoogleAPIsOauthExchangeCodeForTokenStrategy(this.diexConfigService);
