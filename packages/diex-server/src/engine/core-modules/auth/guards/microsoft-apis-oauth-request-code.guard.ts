...
export class MicrosoftAPIsOauthRequestCodeGuard extends AuthGuard(
  ...
  async canActivate(context: ExecutionContext) {
    ...
    try {
      if (
        !this.diexConfigService.get('MESSAGING_PROVIDER_MICROSOFT_ENABLED') &&
        !this.diexConfigService.get('CALENDAR_PROVIDER_MICROSOFT_ENABLED')
      ) {
      ...
      new MicrosoftAPIsOauthRequestCodeStrategy(this.diexConfigService);
