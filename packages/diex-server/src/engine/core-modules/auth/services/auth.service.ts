...
import ms from 'ms';
import { PasswordUpdateNotifyEmail } from 'diex-emails';
import { PermissionFlagType } from 'diex-shared/constants';
import { AppPath, ConnectedAccountProvider } from 'diex-shared/types';
...
export class AuthService {
  ...
  async checkIsEmailVerified(isEmailVerified: boolean) {
    const isEmailVerificationRequired = this.diexConfigService.get(
