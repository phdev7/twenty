...
import ms from 'ms';
import { assertIsDefinedOrThrow } from 'diex-shared/utils';
import { isWorkspaceProvisioned } from 'diex-shared/workspace';
...
export class AccessTokenService {
  ...
  >): Promise<AuthToken> {
    const expiresIn = this.diexConfigService.get('ACCESS_TOKEN_EXPIRES_IN');
