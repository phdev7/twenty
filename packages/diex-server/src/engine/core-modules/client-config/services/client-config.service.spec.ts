  ...
  describe('getClientConfig', () => {
      ...
      jest
        ...
        .mockImplementation((key: string) => {
          const mockValues: Record<string, any> = {
            ...
            CALENDAR_BOOKING_PAGE_ID: 'team/diex/talk-to-us',
            CLOUDFLARE_API_KEY: undefined,
            CLOUDFLARE_ZONE_ID: undefined,
            ALLOW_REQUESTS_TO_DIEX_ICONS: false,
    ...
    it('should return complete client config with all properties', async () => {
      ...
      expect(result).toEqual({
        ...
        calendarBookingPageId: 'team/diex/talk-to-us',
