...
import { type ConfigVariablesMetadataMap } from 'src/engine/core-modules/diex-config/decorators/config-variables-metadata.decorator';
...
import { typeTransformers } from 'src/engine/core-modules/diex-config/utils/type-transformers.registry';
