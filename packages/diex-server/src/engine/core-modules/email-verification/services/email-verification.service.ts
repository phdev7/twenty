...
import ms from 'ms';
import { SendEmailVerificationLinkEmail } from 'diex-emails';
...
export class EmailVerificationService {
  ...
  async sendVerificationEmail({
    ...
    if (!this.diexConfigService.get('IS_EMAIL_VERIFICATION_REQUIRED')) {
    ...
    const emailVerificationMsg =
      verificationTrigger === EmailVerificationTrigger.EMAIL_UPDATE
        ...
        : msg`Welcome to Diex: Please Confirm Your Email`;
