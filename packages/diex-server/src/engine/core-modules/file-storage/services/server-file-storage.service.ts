...
import { type ServerFileFolder } from 'diex-shared/types';
...
export class ServerFileStorageService {
  ...
  constructor(
    ...
    // eslint-disable-next-line diex/prefer-workspace-scoped-repository -- server-scoped rows (workspaceId IS NULL) are unreachable through the scoped wrapper; every query below pins workspaceId to IsNull()
