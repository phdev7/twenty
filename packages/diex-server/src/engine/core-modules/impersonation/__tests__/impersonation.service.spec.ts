...
const DiexConfigServiceGetMock = jest.fn();

describe('ImpersonationService', () => {
  let service: ImpersonationService;

  beforeEach(async () => {
    DiexConfigServiceGetMock.mockImplementation((key: string) => {
      if (key === 'NODE_ENV') {
        ...
        },
        {
          ...
          useValue: {
            getWorkspaceUrls: jest.fn().mockReturnValue({
              customUrl: undefined,
              subdomainUrl: 'https://diex.diex.com',
            }),
          },
        },
        {
