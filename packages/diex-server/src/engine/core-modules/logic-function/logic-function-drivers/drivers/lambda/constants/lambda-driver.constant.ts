...
export const COMMON_LAYER_NAME_PREFIX = 'diex-common-layer';
export const YARN_INSTALL_FUNCTION_NAME_PREFIX = 'diex-yarn-install';
export const BUILDER_FUNCTION_NAME_PREFIX = 'diex-builder';

export const SDK_LAYER_PREFIX_IN_ZIP = 'nodejs/node_modules/diex-client-sdk';

export const LAMBDA_PREBUILT_BUNDLE_CHECKSUM_TAG = 'diex:bundle-checksum';
