...
`,
  ...
  // diex-sdk is build-time only and diex-client-sdk is injected at runtime
  // by Diex (Lambda SDK layer / server-served modules), so neither needs to
  ...
  private async removeBuildTimeSdkFromDependencies(
    ...
    const packagesToRemove = ['diex-sdk', 'diex-client-sdk'];
