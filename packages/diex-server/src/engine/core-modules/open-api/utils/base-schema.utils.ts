...
access to your workspace is the **Diex MCP server**, not this OpenAPI schema.
...
\`\`\`bash
curl -H 'Authorization: Bearer <token>' \\
  ${serverUrl}/rest/open-api/${schemaName} > diex-${schemaName}.json
\`\`\`
`,
      ...
      license: {
        name: 'AGPL-3.0',
        url: 'https://github.com/diexhq/diex?tab=License-1-ov-file#readme',
      },
      version: API_Version,
    },
    // Testing purposes
