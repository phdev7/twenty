...
@Injectable()
export class AgendaToolProvider implements ToolProvider {
  readonly category = ToolCategory.DIEX;

  constructor(
    private readonly agendaToolService: AgendaToolWorkspaceService,
  ...
  private buildToolSet(context: ToolProviderContext): ToolSet {
    return this.agendaToolService.generateAgendaTools(context.workspaceId);
  }
}
