...
@Injectable()
export class CommercialIntelligenceToolProvider implements ToolProvider {
  readonly category = ToolCategory.DIEX;

  constructor(
    private readonly commercialIntelligenceToolService: CommercialIntelligenceToolWorkspaceService,
  ...
  private buildToolSet(context: ToolProviderContext): ToolSet {
    return this.commercialIntelligenceToolService.generateCommercialIntelligenceTools(
      context.workspaceId,
    );
  }
}
