...
@Injectable()
export class InboxToolProvider implements ToolProvider {
  readonly category = ToolCategory.DIEX;

  constructor(
    private readonly inboxToolService: InboxToolWorkspaceService,
  ...
  private buildToolSet(context: ToolProviderContext): ToolSet {
    return this.inboxToolService.generateInboxTools(context.workspaceId);
  }
}
