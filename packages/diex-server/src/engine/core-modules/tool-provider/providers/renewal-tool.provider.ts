...
@Injectable()
export class RenewalToolProvider implements ToolProvider {
  readonly category = ToolCategory.DIEX;

  constructor(
    private readonly renewalToolService: RenewalToolWorkspaceService,
  ...
  private buildToolSet(context: ToolProviderContext): ToolSet {
    return this.renewalToolService.generateRenewalTools(context.workspaceId);
  }
}
