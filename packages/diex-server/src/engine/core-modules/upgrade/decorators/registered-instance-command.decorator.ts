...
import { type DiexAllVersion } from 'src/engine/core-modules/upgrade/constants/diex-all-versions.constant';
...
// When dropping a version from DIEX_CROSS_UPGRADE_SUPPORTED_VERSIONS, also
