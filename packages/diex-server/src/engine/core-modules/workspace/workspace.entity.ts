...
import { ADD_DIEX_ONBOARDING_PRIMARY_CHANNEL_UPGRADE_COMMAND_NAME } from 'src/database/commands/upgrade-version-command/2-26/add-diex-onboarding-primary-channel-upgrade-command-name.constant';
...
export class WorkspaceEntity {
  ...
  @WasIntroducedInUpgrade({
    upgradeCommandName:
      ADD_DIEX_ONBOARDING_PRIMARY_CHANNEL_UPGRADE_COMMAND_NAME,
  })
  @Column({ type: 'varchar', length: 24, nullable: true })
  onboardingPrimaryChannel: string | null;
