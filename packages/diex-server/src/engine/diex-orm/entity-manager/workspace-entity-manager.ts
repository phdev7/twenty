...
import { isDefined, isNonEmptyArray } from 'diex-shared/utils';
import {
  type DeleteResult,
  EntityManager,
  type EntityTarget,
...
import { type DeepPartialWithNestedRelationFields } from 'src/engine/diex-orm/entity-manager/types/deep-partial-entity-with-nested-relation-fields.type';
...
import { getEntityTarget } from 'src/engine/diex-orm/entity-manager/utils/get-entity-target';
...
import { type GlobalWorkspaceDataSource } from 'src/engine/diex-orm/global-workspace-datasource/global-workspace-datasource';
import {
  type OperationType,
  validateOperationIsPermittedOrThrow,
} from 'src/engine/diex-orm/repository/permissions.utils';
import { WorkspaceSelectQueryBuilder } from 'src/engine/diex-orm/repository/workspace-select-query-builder';
import { WorkspaceRepository } from 'src/engine/diex-orm/repository/workspace.repository';
...
import { computePermissionIntersection } from 'src/engine/diex-orm/utils/compute-permission-intersection.util';
