import { type ObjectsPermissionsByRoleId } from 'diex-shared/types';
...
import { WorkspaceEntityManager } from 'src/engine/diex-orm/entity-manager/workspace-entity-manager';
import { type WorkspaceQueryRunner } from 'src/engine/diex-orm/query-runner/workspace-query-runner';
