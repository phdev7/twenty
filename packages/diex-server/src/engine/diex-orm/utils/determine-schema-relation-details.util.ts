import {
  ...
  RelationType as DiexRelationType,
...
} from 'src/engine/diex-orm/exceptions/relation.exception';
import {
  type EntitySchemaFieldMetadata,
  type EntitySchemaFieldMetadataMaps,
  type EntitySchemaObjectMetadataMaps,
} from 'src/engine/diex-orm/global-workspace-datasource/types/entity-schema-metadata.type';
import { computeMorphOrRelationFieldJoinColumnName } from 'src/engine/metadata-modules/field-metadata/utils/compute-morph-or-relation-field-join-column-name.util';
import { converRelationTypeToTypeORMRelationType } from 'src/engine/diex-orm/utils/convert-relation-type-to-typeorm-relation-type.util';
...
export function determineSchemaRelationDetails(
  ...
  const isManyToOne =
    fieldMetadata.settings.relationType === DiexRelationType.MANY_TO_ONE;
