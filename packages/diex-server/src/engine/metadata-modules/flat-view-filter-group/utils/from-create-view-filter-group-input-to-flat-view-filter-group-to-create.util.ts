import { trimAndRemoveDuplicatedWhitespacesFromObjectStringProperties } from 'diex-shared/utils';
import { v4 } from 'uuid';
import { ViewFilterGroupLogicalOperator } from 'diex-shared/types';
