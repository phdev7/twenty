...
import { compositeTypeDefinitions, RelationType } from 'diex-shared/types';
...
import { MAX_CUSTOM_INDEXES_PER_OBJECT } from 'diex-shared/constants';
  ...
  async deleteOne({
    ...
    if (!flatIndexToDelete.isCustom) {
      throw new IndexMetadataException(
        ...
        {
          userFriendlyMessage: msg`System indexes are required for Diex to work and cannot be deleted.`,
        },
      );
    }
