...
import { ViewVisibility } from 'diex-shared/types';
import { isDefined, uncapitalize } from 'diex-shared/utils';
  ...
  async getMinimalMetadata(
    ...
    const objectMetadataItems: MinimalObjectMetadataDTO[] = Object.values(
      ...
      .map((flatObjectMetadata) => {
        const isStandardApp = belongsToDiexStandardApp(flatObjectMetadata);
