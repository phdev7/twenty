...
jest.mock(
  'src/engine/diex-orm/utils/build-row-level-permission-record-filter.util',
  () => ({
...
jest.mock(
  'src/engine/diex-orm/utils/is-record-matching-rls-row-level-permission-predicate.util',
  () => ({
...
} = require('src/engine/diex-orm/utils/build-row-level-permission-record-filter.util');
const {
  isRecordMatchingRLSRowLevelPermissionPredicate,
} = require('src/engine/diex-orm/utils/is-record-matching-rls-row-level-permission-predicate.util');
