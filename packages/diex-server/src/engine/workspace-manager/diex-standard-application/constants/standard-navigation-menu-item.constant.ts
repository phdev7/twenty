...
export const STANDARD_NAVIGATION_MENU_ITEMS = {
  ...
  agencyTrafficDashboard: {
    ...
    type: NavigationMenuItemType.VIEW,
    name: 'Painel de Tráfego',
    icon: 'IconChartBar',
    link: '/agency/traffic-dashboard',
    position: 0,
    folderUniversalIdentifier: 'd1e09000-0000-4000-8000-000000000001',
  },
  agencyCustomMetrics: {
    universalIdentifier: 'd1e09000-0000-4000-8000-000000000003',
    type: NavigationMenuItemType.VIEW,
    name: 'Métricas Modeláveis',
    icon: 'IconAdjustments',
    link: '/agency/custom-metrics',
    position: 1,
    folderUniversalIdentifier: 'd1e09000-0000-4000-8000-000000000001',
  },
  agencyMetaAds: {
    universalIdentifier: 'd1e09000-0000-4000-8000-000000000004',
    type: NavigationMenuItemType.VIEW,
    name: 'Meta Ads',
    icon: 'IconBrandFacebook',
    link: '/agency/meta-ads',
    position: 2,
    folderUniversalIdentifier: 'd1e09000-0000-4000-8000-000000000001',
  },
  offers: {
