...
} from 'src/engine/workspace-manager/diex-standard-application/utils/page-layout-config';
import { PageLayoutType } from 'src/engine/metadata-modules/page-layout/enums/page-layout-type.enum';
import { type StandardRecordPageLayouts } from 'src/engine/workspace-manager/diex-standard-application/utils/page-layout-config/standard-page-layout-config.type';
import { type StandardPageLayoutConfig } from 'src/engine/workspace-manager/diex-standard-application/utils/page-layout-config/standard-page-layout-config.type';
