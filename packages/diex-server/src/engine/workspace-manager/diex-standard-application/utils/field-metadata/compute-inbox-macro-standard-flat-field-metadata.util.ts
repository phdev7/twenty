...
export const buildInboxMacroStandardFlatFieldMetadatas = (
  args: Omit<
    CreateStandardFieldArgs<'inboxMacro', FieldMetadataType>,
    'context'
  >,
): Record<AllStandardObjectFieldName<'inboxMacro'>, FlatFieldMetadata> => ({
