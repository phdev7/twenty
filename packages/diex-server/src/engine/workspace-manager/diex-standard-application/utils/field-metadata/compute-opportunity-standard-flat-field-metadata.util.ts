...
>): Record<AllStandardObjectFieldName<'opportunity'>, FlatFieldMetadata> => ({
    ...
    context: {
      ...
      options: [
        ...
        },
        {
          ...
          value: 'SCREENING',
          label: i18nLabel(msg`Qualificação`),
          position: 1,
          color: 'blue',
        },
        {
          ...
          value: 'MEETING',
          label: i18nLabel(msg`Diagnóstico marcado`),
          position: 2,
          color: 'sky',
        },
        {
          id: '20202020-d1e1-4a00-8000-000000000001',
          value: 'DIAGNOSIS_COMPLETE',
          label: i18nLabel(msg`Diagnóstico realizado`),
          position: 3,
          color: 'turquoise',
        },
        {
          ...
          value: 'PROPOSAL',
          label: i18nLabel(msg`Proposta enviada`),
          position: 4,
          color: 'purple',
        },
        {
          id: '20202020-d1e1-4a00-8000-000000000002',
          value: 'NEGOTIATION',
        ...
        },
        {
          ...
          value: 'CUSTOMER',
          label: i18nLabel(msg`Fechado ganho`),
          position: 6,
          color: 'green',
        },
        {
          id: '20202020-d1e1-4a00-8000-000000000003',
          value: 'LOST',
          label: i18nLabel(msg`Fechado perdido`),
          position: 7,
          color: 'red',
        },
      ],
  ...
  pointOfContact: createStandardRelationFieldFlatMetadata({
    ...
    context: {
      ...
      label: i18nLabel(msg`Contato principal`),
