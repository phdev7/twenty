import { getSearchFieldUniversalIdentifier } from 'diex-shared/application';
...
import { METADATA_IDENTITY_APPLICATION_UNIVERSAL_IDENTIFIER_BY_STANDARD_OBJECT_NAME } from 'src/engine/workspace-manager/diex-standard-application/constants/metadata-identity-application-universal-identifier-by-standard-object-name.constant';
