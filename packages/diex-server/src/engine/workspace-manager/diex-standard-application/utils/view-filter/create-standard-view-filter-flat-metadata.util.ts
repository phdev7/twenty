...
import { type ViewFilterOperand } from 'diex-shared/types';
...
import { type AllStandardObjectViewFilterName } from 'src/engine/workspace-manager/diex-standard-application/types/all-standard-object-view-filter-name.type';
