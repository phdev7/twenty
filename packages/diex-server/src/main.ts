...
const bootstrap = async () => {
  ...
  const diexConfigService = app.get(DiexConfigService);
  ...
  const trustProxyRaw = diexConfigService.get('TRUST_PROXY');
  ...
  app.use(session(getSessionStorageOptions(diexConfigService)));
  ...
  const keepAliveTimeout = diexConfigService.get(
  ...
  await app.listen(diexConfigService.get('NODE_PORT'));
};
