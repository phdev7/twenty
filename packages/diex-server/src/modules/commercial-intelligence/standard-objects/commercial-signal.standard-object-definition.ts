...
export const CommercialSignalStandardObjectDefinition = {
  ...
  fields: [
    {
      universalIdentifier: COMMERCIAL_SIGNAL_NAME_FIELD_UNIVERSAL_IDENTIFIER,
    ...
    {
      universalIdentifier: COMMERCIAL_SIGNAL_TYPE_FIELD_UNIVERSAL_IDENTIFIER,
    ...
    {
      universalIdentifier: COMMERCIAL_SIGNAL_SOURCE_FIELD_UNIVERSAL_IDENTIFIER,
      type: FieldMetadataType.SELECT,
      name: 'source',
      label: 'Origem',
      icon: 'IconSourceCode',
    ...
    {
      universalIdentifier: COMMERCIAL_SIGNAL_STATUS_FIELD_UNIVERSAL_IDENTIFIER,
      type: FieldMetadataType.SELECT,
      name: 'status',
      label: 'Status',
      icon: 'IconProgress',
