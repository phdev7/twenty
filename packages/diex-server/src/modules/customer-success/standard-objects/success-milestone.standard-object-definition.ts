...
export const SuccessMilestoneStandardObjectDefinition = {
  ...
  fields: [
    {
      universalIdentifier: SUCCESS_MILESTONE_NAME_FIELD_UNIVERSAL_IDENTIFIER,
    ...
    {
      universalIdentifier: SUCCESS_MILESTONE_STATUS_FIELD_UNIVERSAL_IDENTIFIER,
      type: FieldMetadataType.SELECT,
      name: 'status',
      label: 'Status',
      icon: 'IconProgress',
    ...
    {
      universalIdentifier: SUCCESS_MILESTONE_DUE_AT_FIELD_UNIVERSAL_IDENTIFIER,
    ...
    {
      universalIdentifier: SUCCESS_MILESTONE_OUTCOME_FIELD_UNIVERSAL_IDENTIFIER,
    ...
    {
      universalIdentifier: SUCCESS_MILESTONE_IMPACT_FIELD_UNIVERSAL_IDENTIFIER,
