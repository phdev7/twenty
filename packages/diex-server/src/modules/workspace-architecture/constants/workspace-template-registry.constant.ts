...
const capabilityDefinitions: CapabilityDefinition[] = [
  {
    id: 'acquisition',
    name: 'Aquisição',
    description: 'Organiza canais, campanhas, origem e velocidade de entrada de leads.',
    keywords: ['aquisição', 'marketing', 'inbound', 'outbound', 'lead', 'captação', 'campanha'],
  ...
  },
  {
    ...
    keywords: ['prospecção', 'lista de prospecção', 'cadência', 'abordagem', 'sd r', 'sdr'],
  ...
  },
  {
    ...
    keywords: ['qualificação', 'qualificar', 'mql', 'sql', 'pré-vendas', 'pre vendas'],
  ...
  },
  {
    ...
    keywords: ['vendas', 'venda', 'comercial', 'oportunidade', 'proposta', 'forecast', 'fechamento'],
  ...
  },
  {
    ...
    keywords: ['orçamento', 'orcamento', 'cotação', 'cotacao', 'proposta comercial', 'licitação', 'licitacao'],
  ...
  },
  {
    ...
    description: 'Organiza horários, visitas, reservas e capacidade disponível.',
    keywords: ['agenda', 'agendamento', 'agendar', 'visita', 'consulta', 'reserva', 'booking', 'appointment'],
  ...
  },
  {
    ...
    keywords: ['serviço em campo', 'servico em campo', 'assistência técnica', 'assistencia tecnica', 'instalação', 'instalacao', 'técnico', 'tecnico', 'manutenção externa', 'manutencao externa'],
  ...
  },
  {
    ...
    keywords: ['implantação', 'implantacao', 'go-live', 'go live', 'onboarding de cliente', 'ativação de cliente', 'ativacao de cliente'],
  ...
  },
  {
    ...
    description: 'Controla escopo, marcos, prazos, capacidade e evidência de valor.',
    keywords: ['projeto', 'projetos', 'entrega', 'marco', 'escopo', 'obra', 'construção', 'construcao'],
  ...
  },
  {
    ...
    keywords: ['produção', 'producao', 'fabricação', 'fabricacao', 'fábrica', 'fabrica', 'manufatura', 'sob medida', 'linha de produção', 'linha de producao'],
    metrics: ['ordens_de_producao', 'producao_no_prazo', 'capacidade_utilizada'],
    icon: 'factory',
    navigationGroup: 'Operação',
    renderer: 'OPERATIONS',
    blockType: 'PIPELINE',
  ...
  },
  {
    ...
    keywords: ['estoque', 'inventário', 'inventario', 'insumo', 'materiais', 'produto físico', 'produto fisico', 'catálogo', 'catalogo'],
  ...
  },
  {
    ...
    description: 'Organiza fornecedores, cotações, pedidos e prazos de entrada.',
    keywords: ['compras', 'fornecedor', 'fornecedores', 'suprimentos', 'cotação de fornecedor', 'cotacao de fornecedor'],
    metrics: ['pedidos_de_compra', 'compras_em_aberto', 'prazo_medio_de_fornecedor'],
    icon: 'truck',
    navigationGroup: 'Operação',
    renderer: 'OPERATIONS',
    blockType: 'LIST',
  ...
  },
  {
    ...
    keywords: ['logística', 'logistica', 'entrega ao cliente', 'expedição', 'expedicao', 'pedido', 'pedidos', 'fulfillment', 'distribuição', 'distribuicao'],
  ...
  },
  {
    ...
    keywords: ['customer success', 'sucesso do cliente', 'adoção', 'adocao', 'saúde da carteira', 'saude da carteira'],
    metrics: ['health_score', 'time_to_value', 'adocao', 'churn_risk', 'expansion'],
    icon: 'users',
    navigationGroup: 'Relacionamento',
    renderer: 'DASHBOARD',
    blockType: 'KPI',
  ...
  },
  {
    ...
    keywords: ['renovação', 'renovacao', 'vigência', 'vigencia', 'churn', 'expansão', 'expansao'],
  ...
  },
  {
    ...
    keywords: ['cobrança', 'cobranca', 'inadimplência', 'inadimplencia', 'vencimento', 'financeiro', 'recebimento', 'contas a receber'],
  ...
  },
  {
    ...
    description: 'Controla vigência, documentos, aprovações e riscos contratuais.',
    keywords: ['contrato', 'contratos', 'jurídico', 'juridico', 'vigência contratual', 'vigencia contratual', 'documentos'],
    metrics: ['contratos_ativos', 'contratos_a_vencer', 'pendencias_contratuais'],
    icon: 'document',
  ...
  },
  {
    ...
    keywords: ['assinatura', 'assinaturas', 'recorrência', 'recorrencia', 'mensalidade', 'mrr', 'arr'],
  ...
  },
  {
    ...
    keywords: ['escola', 'educação', 'educacao', 'curso', 'cursos', 'aluno', 'turma', 'treinamento', 'capacitação', 'capacitacao'],
  ...
  },
  {
    ...
    keywords: ['evento', 'eventos', 'inscrição', 'inscricao', 'congresso', 'feira', 'experiência', 'experiencia'],
  ...
  },
  {
    ...
    keywords: ['recrutamento', 'seleção', 'selecao', 'candidato', 'candidatos', 'vaga', 'talentos', 'rh'],
    metrics: ['vagas_abertas', 'candidatos_em_processo', 'tempo_de_contratacao'],
    icon: 'users',
    navigationGroup: 'Operação',
    renderer: 'PIPELINE',
    blockType: 'PIPELINE',
  ...
  },
  {
    ...
    description: 'Governa parceiros, indicações, distribuição e receita compartilhada.',
    keywords: ['parceiro', 'parceiros', 'revenda', 'representante', 'indicação', 'indicacao', 'canal de vendas'],
  ...
  },
  {
    ...
    description: 'Registra controles, evidências, incidentes e planos corretivos.',
    keywords: ['qualidade', 'conformidade', 'compliance', 'auditoria', 'incidente', 'iso', 'lgpd'],
    metrics: ['pendencias_de_conformidade', 'incidentes_abertos', 'auditorias_no_prazo'],
    icon: 'shield',
    navigationGroup: 'Governança',
    renderer: 'OPERATIONS',
    blockType: 'CHECKLIST',
  ...
  },
  {
    ...
    keywords: ['casos', 'processo', 'processos', 'contencioso', 'atendimento especializado', 'dossiê', 'dossie'],
  ...
  },
  {
    ...
    keywords: ['ia', 'inteligência artificial', 'inteligencia artificial', 'aprovação', 'aprovacao', 'auditoria'],
  ...
  },
  {
    ...
    keywords: ['unidades', 'filiais', 'franquias', 'lojas', 'regional', 'multiunidade', 'multi unidade'],
    metrics: ['unidades_ativas', 'receita_por_unidade', 'performance_por_unidade'],
    icon: 'building',
    navigationGroup: 'Governança',
    renderer: 'DASHBOARD',
    blockType: 'KPI',
