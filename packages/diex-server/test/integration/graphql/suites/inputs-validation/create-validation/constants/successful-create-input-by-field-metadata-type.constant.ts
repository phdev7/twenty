  ...
  [FieldMetadataType.LINKS]: [
    {
      input: {
        linksField: {
          primaryLinkUrl: 'https://diex.com',
          primaryLinkLabel: '#1 Open source CRM',
          secondaryLinks: [{ url: 'diex.com', label: '#1 Open source CRM' }],
        },
      },
      validateInput: (record: Record<string, any>) => {
        return (
          record.linksField.primaryLinkUrl === 'https://diex.com' &&
          record.linksField.primaryLinkLabel === '#1 Open source CRM' &&
          record.linksField.secondaryLinks.length === 1 &&
          record.linksField.secondaryLinks[0].url === 'diex.com' &&
