...
// Mirrors OBJECT_METADATA_FRAGMENT from diex-front
// (packages/diex-front/src/modules/object-metadata/graphql/fragment.ts):
...
// Mirrors VIEW_FRAGMENT from diex-front
// (packages/diex-front/src/modules/views/graphql/fragments/viewFragment.ts).
