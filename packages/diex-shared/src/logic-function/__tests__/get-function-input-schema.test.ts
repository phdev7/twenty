...
describe('getFunctionInputSchema', () => {
  ...
  it('should resolve DiexRecord markers to record schemas', () => {
    const fileContent = `
        export const main = (params: {
          company: DiexRecord<'company-universal-identifier'>;
          companies: DiexRecord<'company-universal-identifier'>[];
          otherCompanies: Array<DiexRecord<'company-universal-identifier'>>;
        }): void => {
          return;
        };
      `;
  ...
  it('should leave a bare DiexRecord without a literal argument unresolved', () => {
    const fileContent = `
        export const main = (params: { record: DiexRecord }): void => {
          return;
        };
      `;
    const result = getFunctionInputSchema(fileContent);
