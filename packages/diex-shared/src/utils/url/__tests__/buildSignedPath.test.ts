...
describe('buildSignedPath', () => {
  ...
  it('should ignore absolute https urls', () => {
    expect(
      buildSignedPath({
        path: 'https://diexhq.github.io/placeholder-images/workspaces/diex-logo.png',
        token: 'tokenValue',
      }),
    ).toBe(
      'https://diexhq.github.io/placeholder-images/workspaces/diex-logo.png',
    );
  });
  ...
  it('should ignore absolute http urls', () => {
    expect(
      buildSignedPath({
        path: 'http://diexhq.github.io/placeholder-images/workspaces/diex-logo.png',
        token: 'tokenValue',
      }),
    ).toBe(
      'http://diexhq.github.io/placeholder-images/workspaces/diex-logo.png',
    );
  });
});
