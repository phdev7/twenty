...
const nextConfig: LinariaConfig = {
  ...
  async redirects() {
    return [
      ...
      {
        source: '/',
        has: [{ type: 'host', value: 'www.diex.com' }],
        destination: 'https://diex.com/',
        permanent: true,
      },
      {
        source: '/:path*',
        has: [{ type: 'host', value: 'www.diex.com' }],
        destination: 'https://diex.com/:path*',
        permanent: true,
      },
      {
        source: '/',
        has: [{ type: 'host', value: 'www.diex-main.com' }],
        destination: 'https://diex-main.com/',
        permanent: true,
      },
      {
        source: '/:path*',
        has: [{ type: 'host', value: 'www.diex-main.com' }],
        destination: 'https://diex-main.com/:path*',
        permanent: true,
      },
      ...
      {
        source: '/user-guide',
        destination: 'https://docs.diex.com/user-guide/introduction',
        permanent: true,
      },
      {
        source: '/user-guide/section/:folder/:slug*',
        destination: 'https://docs.diex.com/user-guide/:folder/:slug*',
        permanent: true,
      },
      {
      ...
      {
        source: '/developers',
        destination: 'https://docs.diex.com/developers/introduction',
        permanent: true,
      },
      {
        source: '/developers/section/:folder/:slug*',
        destination: 'https://docs.diex.com/developers/:folder/:slug*',
        permanent: true,
      },
      {
      ...
      {
        source: '/diex-ui',
        destination: 'https://docs.diex.com/diex-ui/introduction',
        permanent: true,
      },
      {
        source: '/diex-ui/section/:folder/:slug*',
        destination: 'https://docs.diex.com/diex-ui/:folder/:slug*',
        permanent: true,
      },
      {
        source: '/diex-ui/:folder/:slug*',
        destination: 'https://docs.diex.com/diex-ui/:folder/:slug*',
        permanent: true,
      },
      {
        source: '/resources/why-diex',
        destination: '/why-diex',
        permanent: true,
      },
      {
        source: '/story',
