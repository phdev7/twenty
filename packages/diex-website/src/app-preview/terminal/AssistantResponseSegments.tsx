...
const buildCustomerParagraph = (
  ...
  text(
    ' object that ships with Diex, so accounts, domain favicons, and the People relation work for free. ',
  ),
...
const WRAPUP_PARAGRAPH: StreamingSegment[] = [
  ...
  text(', and '),
  node('w-dev', <InlineCode>yarn diex dev --once</InlineCode>),
  text('. Reference: '),
  node(
    'w-docs',
    <ReferenceLink
      href="https://diex.com/developers"
      onClick={(event) => event.preventDefault()}
    >
      Diex app-building docs
    </ReferenceLink>,
  ),
  text('.'),
];
