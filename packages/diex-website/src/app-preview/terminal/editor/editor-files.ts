...
// old editor-data (30 files of authored diex-sdk source fiction).
...
const rocketObjectSource = `import { defineObject, FieldType, RelationType } from 'diex-sdk/define';
...
export default defineObject({
  ...
  fields: [
    ...
    },
    {
      ...
      // Customer object — we reuse what ships with Diex).
...
const launchSiteObjectSource = `import { defineObject, FieldType, RelationType } from 'diex-sdk/define';
...
const launchesViewSource = `import { defineView, ViewKey } from 'diex-sdk/define';
...
const rocketsViewSource = `import { defineView, ViewKey } from 'diex-sdk/define';
...
const payloadsViewSource = `import { defineView, ViewKey } from 'diex-sdk/define';
...
const launchSitesViewSource = `import { defineView, ViewKey } from 'diex-sdk/define';
...
const applicationConfigSource = `import { defineApplication } from 'diex-sdk/define';
