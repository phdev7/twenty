...
export type PartnerApplicationLogicFunctionPayload = {
  ...
  diexExperience: readonly PartnerDiexExperienceValue[];
...
export function buildLogicFunctionPayload(
  ...
  const payload: PartnerApplicationLogicFunctionPayload = {
    ...
    diexExperience: request.diexExperience,
    diexExperienceNotes: request.diexExperienceNotes,
    diexExperienceProofLink: request.diexExperienceProofLink,
  };
