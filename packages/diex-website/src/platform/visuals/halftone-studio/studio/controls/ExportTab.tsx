...
const DEFAULT_IMAGE_FILE_NAME = 'diex-logo.svg';
const DEFAULT_IMAGE_LABEL = 'Diex image';
const REACT_EXPORT_SETTING_OPTIONS: Array<{
  ...
  },
  {
    ...
    description:
      'Wraps the mount node with a StyledVisualMount using @linaria/react and keeps the Diex-ready mount shape.',
  },
  {
    key: 'includeUseClientDirective',
    label: "Add 'use client'",
    description:
      'Prepends the Next.js client directive so the exported component can be dropped into the Diex website directly.',
  },
  {
  ...
  },
  {
    ...
    description:
      'Exports both a named component and a default export to match the current Diex illustration import pattern.',
  },
  {
    key: 'includeRegistryComment',
    label: 'Add Diex header comment',
    description:
