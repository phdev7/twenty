...
export const FAQ_QUESTIONS: readonly FaqQuestion[] = [
  {
    question: msg`Is Diex really open-source?`,
    answer: msg`Yes. Diex is the #1 Open Source CRM on GitHub. You can self-host to fully own your infrastructure, or run it on our managed cloud for a zero-ops setup.`,
  },
  {
  ...
  {
    question: msg`Do I need a developer to customize Diex?`,
    answer: msg`No. Build custom objects, fields, views, and no-code workflows straight from Settings. Unlimited, no extra charge.`,
  },
  {
    question: msg`Can developers extend Diex with code?`,
    answer: msg`Yes, with our Apps framework. Scaffold an extension with \`npx create-diex-app\` and ship custom objects, server-side logic functions, React components that render inside Diex’s UI, AI skills and agents, views, and navigation, all in TypeScript, deployable to any workspace.`,
  },
  {
    question: msg`Does Diex work with Claude, ChatGPT, and Cursor?`,
  ...
  {
    question: msg`What does Diex cost?`,
