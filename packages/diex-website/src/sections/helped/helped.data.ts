...
export const HELPED_CARDS: readonly HelpedCardRecord[] = [
  {
    wordmark: 'W3villa',
    heading: msg`Ship a product on Diex`,
    body: msg`W3villa built W3Grads for AI mock interviews at scale, with Diex as the operational backbone.`,
    illustration: 'target',
  ...
  },
  {
    ...
    body: msg`AC&T replaced a shuttered vendor CRM with self-hosted Diex and cut CRM costs by more than 90%.`,
  ...
  },
  {
    ...
    body: msg`NetZero runs a modular Diex setup across carbon credits, ag products, and industrial systems.`,
    illustration: 'money',
