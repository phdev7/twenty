  ...
  return (
    <>
      ...
      <p>
        ...
        contact@diex.com so we can try to find a solution. These Terms apply
      ...
      <p>
        ...
        renew under the exact same conditions unless you cancel it or Diex.com
        PBC cancels it. You may cancel your Subscription renewal either through
        your online account management page or by contacting Diex.com PBC
        customer support team.
      </p>
      <p>
        A valid payment method, including credit card, is required to process
        the payment for your subscription. You shall provide Diex.com PBC with
        ...
        authorize Diex.com PBC to charge all Subscription fees incurred
        through your account to any such payment instruments.
      </p>
      <p>
        Should automatic billing fail to occur for any reason, Diex.com PBC
      ...
      <h2>Free Trial</h2>
      <p>
        Diex.com PBC may, at its sole discretion, offer a Subscription with a
      ...
      <p>
        ...
        you will not be charged by Diex.com PBC until Free Trial has expired.
      ...
      <p>
        At any time and without notice, Diex.com PBC reserves the right to (i)
      ...
      <h2>Fee changes</h2>
      <p>
        Diex.com PBC, in its sole discretion and at any time, may modify
      ...
      <p>
        Diex.com PBC will provide you with a reasonable prior notice of any
      ...
      <p>
        Diex.com PBC has the right but not the obligation to monitor and edit
      ...
      <p>
        ...
        Diex.com PBC and its licensors. Service is protected by copyright,
        ...
        the prior written consent of Diex.com PBC.
      </p>

      <h2>Error Reporting and Feedback</h2>
      <p>
        You may provide us either directly at contact@diex.com or via third
      ...
      <p>
        ...
        are not owned or controlled by Diex.com PBC.
      </p>
      <p>
        Diex.com PBC has no control over, and assumes no responsibility for
      ...
      <p>
        YOU ACKNOWLEDGE AND AGREE THAT DIEX.COM PBC SHALL NOT BE RESPONSIBLE
      ...
      <p>
        By email: <a href="mailto:contact@diex.com">contact@diex.com</a>.
      </p>
    </>
  );
}
