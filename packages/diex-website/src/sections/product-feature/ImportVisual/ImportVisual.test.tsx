...
describe('ImportVisual', () => {
  it('renders the imported-data and diex-fields columns', () => {
    renderVisual();

    expect(screen.getByText('Imported data')).toBeInTheDocument();
    expect(screen.getByText('Diex fields')).toBeInTheDocument();
  });
  ...
  it('maps the imported columns onto Diex fields', () => {
    renderVisual();
