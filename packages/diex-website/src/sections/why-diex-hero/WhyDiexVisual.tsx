...
import { WHY_DIEX_HERO } from './why-diex-visual-config';

// The /why-diex hero: a textured backdrop with the halftone "20" floating
    ...
    <VisualFrame aria-hidden>
      <BackgroundLayer>
        <NextImage
          ...
          priority
          sizes="100vw"
          src="/images/why-diex/hero/background.webp"
        />
      </BackgroundLayer>
      <ForegroundLayer>
        <HalftoneModel
          initialPose={WHY_DIEX_HERO.initialPose}
          modelUrl={WHY_DIEX_HERO.modelUrl}
          priority
          settings={WHY_DIEX_HERO.settings}
        />
      </ForegroundLayer>
    </VisualFrame>
  );
