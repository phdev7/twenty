...
// straight from diex-ui: TAG (tag color3/11), SIDEBAR (TintedIconTile
...
// diex-ui colors are `color(display-p3 r g b)` strings with 0–1 channels;
...
// The Ask-AI panel washes map onto diex-ui's transparent ramp + primary
...
// diex-front's graph-color registry assigns chart series from the color8
