...
import { INBOX_TEAM_MEMBERS_VIEW_UNIVERSAL_IDENTIFIER } from 'src/modules/inbox/constants/inbox-team.constants';
...
export default defineNavigationMenuItem({
  ...
  viewUniversalIdentifier: INBOX_TEAM_MEMBERS_VIEW_UNIVERSAL_IDENTIFIER,
});
