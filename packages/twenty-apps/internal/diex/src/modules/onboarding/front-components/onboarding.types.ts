import { type WhatsappConnectionResult } from 'src/modules/inbox/logic-functions/whatsapp-connection.logic-function';

export type WhatsappConnection = WhatsappConnectionResult;
