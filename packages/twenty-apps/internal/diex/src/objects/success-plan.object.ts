...
export default defineObject({
  ...
  fields: [
    ...
    {
      universalIdentifier:
        SUCCESS_PLAN_HEALTH_SCORE_FIELD_UNIVERSAL_IDENTIFIER,
    ...
    {
      universalIdentifier:
        SUCCESS_PLAN_START_DATE_FIELD_UNIVERSAL_IDENTIFIER,
      type: FieldType.DATE,
      name: 'startDate',
      label: 'Início',
    ...
    {
      universalIdentifier:
        SUCCESS_PLAN_OBJECTIVES_FIELD_UNIVERSAL_IDENTIFIER,
