...
export default defineObject({
  ...
  fields: [
    ...
    {
      universalIdentifier: WORKSPACE_CONTEXT_BUSINESS_FIELD_UNIVERSAL_IDENTIFIER,
    ...
    },
    {
      ...
      description: 'Objeções recorrentes e a resposta que a empresa considera correta.',
    ...
    },
    {
      ...
      label: 'Concorrência',
      description: 'Concorrentes relevantes e o posicionamento da empresa diante deles.',
      icon: 'IconSwords',
      isNullable: true,
    },
    {
