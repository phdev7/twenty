...
export const FIND_ELIGIBLE_TWENTY_EMAIL_CHANNELS = gql`
  query FindEligibleTwentyEmailChannels {
    myMessageChannels {
      id
      handle
      type
...
export const FIND_TWENTY_EMAIL_MESSAGE_ASSOCIATIONS = gql`
  query FindTwentyEmailMessageAssociations(
...
export const SEND_TWENTY_EMAIL = gql`
  mutation SendTwentyEmail($input: SendEmailInput!) {
