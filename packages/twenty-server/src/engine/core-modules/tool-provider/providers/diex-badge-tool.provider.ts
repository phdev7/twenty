...
@Injectable()
export class DiexBadgeToolProvider implements ToolProvider {
  readonly category = ToolCategory.DIEX;

  constructor(
    private readonly diexBadgeToolService: DiexBadgeToolWorkspaceService,
  ...
  private buildToolSet(context: ToolProviderContext): ToolSet {
    return this.diexBadgeToolService.generateBadgeTools(context.workspaceId);
  }
}
