...
@Injectable()
export class WorkspaceContextToolProvider implements ToolProvider {
  readonly category = ToolCategory.DIEX;

  constructor(
    private readonly workspaceContextToolService: WorkspaceContextToolWorkspaceService,
  ...
  private buildToolSet(context: ToolProviderContext): ToolSet {
    return this.workspaceContextToolService.generateWorkspaceContextTools(
      context.workspaceId,
    );
  }
}
