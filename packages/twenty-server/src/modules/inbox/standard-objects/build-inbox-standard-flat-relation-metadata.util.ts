...
import { INBOX_STANDARD_RELATION_DEFINITIONS } from 'src/modules/inbox/standard-objects/inbox-standard-relation-definitions.constant';
...
export const buildInboxStandardRelationFlatFieldMetadatas = <
  O extends AllStandardObjectName,
>(
  ...
  const relationDefinitions = INBOX_STANDARD_RELATION_DEFINITIONS.filter(
    (definition) =>
